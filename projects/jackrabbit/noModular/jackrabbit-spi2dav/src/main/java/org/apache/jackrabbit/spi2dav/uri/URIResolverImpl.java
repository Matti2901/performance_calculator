 ...
 */
package org.apache.jackrabbit.spi2dav.uri;
...
public class URIResolverImpl implements URIResolver {
    ...
    public URIResolverImpl(URI repositoryUri, RepositoryServiceImpl service, Document domFactory) {
    ...
    public String getWorkspaceUri(String workspaceName) {
    ...
    public String getRootItemUri(String workspaceName) {
        return getWorkspaceUri(workspaceName) + Text.escapePath(JcrRemotingConstants.ROOT_ITEM_RESOURCEPATH);
    }

    public String getItemUri(ItemId itemId, String workspaceName, SessionInfo sessionInfo)
    ...
    public  NodeId buildNodeId(NodeId parentId, String baseUri, MultiStatusResponse response,
    ...
    public  PropertyId buildPropertyId(NodeId parentId, MultiStatusResponse response,
                               String workspaceName, NamePathResolver resolver) throws RepositoryException {
        IdURICache cache = getCache(workspaceName);
    ...
    public  void clearCacheEntries(ItemId itemId, SessionInfo sessionInfo) {
