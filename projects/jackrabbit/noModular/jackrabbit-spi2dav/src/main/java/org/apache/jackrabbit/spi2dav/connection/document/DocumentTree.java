 ...
 */
package org.apache.jackrabbit.spi2dav.connection.document;
...
public class DocumentTree extends AbstractTree {

    private final List<Property> properties = new ArrayList<Property>();

    public DocumentTree(Name nodeName, Name ntName, String uniqueId, NamePathResolver resolver) {
