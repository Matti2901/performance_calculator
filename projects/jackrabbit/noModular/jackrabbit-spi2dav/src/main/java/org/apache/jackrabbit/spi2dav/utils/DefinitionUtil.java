 ...
 */
package org.apache.jackrabbit.spi2dav.utils;
...
import org.apache.jackrabbit.spi.commons.nodetype.definition.q.QItemDefinitionBuilder;
import org.apache.jackrabbit.spi.commons.nodetype.definition.q.QNodeDefinitionBuilder;
import org.apache.jackrabbit.spi.commons.nodetype.definition.q.QPropertyDefinitionBuilder;
import org.apache.jackrabbit.spi.commons.nodetype.definition.q.type.QNodeTypeDefinitionBuilder;
...
public class DefinitionUtil implements NodeTypeConstants {
     ...
     */
    public static QNodeDefinition createQNodeDefinition(Name declaringNodeType, Element ndefElement, NamePathResolver resolver) throws RepositoryException {
     ...
     * @throws RepositoryException
     */
    public static QPropertyDefinition createQPropertyDefinition(Name declaringNodeType, Element pdefElement,
    ...
    public static QNodeTypeDefinition createQNodeTypeDefinition(Element ntdElement, NamePathResolver resolver,
