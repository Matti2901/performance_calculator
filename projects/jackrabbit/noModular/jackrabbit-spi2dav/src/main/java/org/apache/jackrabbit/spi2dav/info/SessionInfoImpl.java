 ...
 */
package org.apache.jackrabbit.spi2dav.info;
 ...
 */
public class SessionInfoImpl extends org.apache.jackrabbit.spi.commons.info.SessionInfoImpl {
    ...
    public SessionInfoImpl(CredentialsWrapper creds, String workspaceName) {
     ...
     */
    public void setLastBatchId(String batchId) {
        lastBatchId = batchId;
    }
    ...
    public void setNamePathResolver(NamePathResolver resolver) {
    ...
    public void addLockToken(String token, boolean sessionScoped) {
        if (sessionScoped) {
    ...
    public void removeLockToken(String token, boolean sessionScoped) {
        if (sessionScoped) {
