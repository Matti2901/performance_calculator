...
import org.apache.jackrabbit.jcr2spi.operation.creation.AddLabel;
...
import org.apache.jackrabbit.jcr2spi.operation.versioning.Checkin;
import org.apache.jackrabbit.jcr2spi.operation.versioning.Checkout;
import org.apache.jackrabbit.jcr2spi.operation.versioning.Checkpoint;
import org.apache.jackrabbit.jcr2spi.operation.structure.copy.Clone;
import org.apache.jackrabbit.jcr2spi.operation.structure.copy.Copy;
import org.apache.jackrabbit.jcr2spi.operation.creation.CreateActivity;
import org.apache.jackrabbit.jcr2spi.operation.creation.CreateConfiguration;
import org.apache.jackrabbit.jcr2spi.operation.locking.LockOperation;
import org.apache.jackrabbit.jcr2spi.operation.locking.LockRefresh;
import org.apache.jackrabbit.jcr2spi.operation.locking.LockRelease;
import org.apache.jackrabbit.jcr2spi.operation.structure.merge.Merge;
import org.apache.jackrabbit.jcr2spi.operation.structure.move.Move;
import org.apache.jackrabbit.jcr2spi.operation.Operation;
import org.apache.jackrabbit.jcr2spi.operation.visitor.OperationVisitor;
import org.apache.jackrabbit.jcr2spi.operation.removal.Remove;
import org.apache.jackrabbit.jcr2spi.operation.removal.RemoveActivity;
import org.apache.jackrabbit.jcr2spi.operation.removal.RemoveLabel;
import org.apache.jackrabbit.jcr2spi.operation.versioning.RemoveVersion;
import org.apache.jackrabbit.jcr2spi.operation.structure.move.ReorderNodes;
import org.apache.jackrabbit.jcr2spi.operation.structure.merge.ResolveMergeConflict;
import org.apache.jackrabbit.jcr2spi.operation.versioning.Restore;
import org.apache.jackrabbit.jcr2spi.operation.set.SetMixin;
import org.apache.jackrabbit.jcr2spi.operation.set.tree.SetTree;
import org.apache.jackrabbit.jcr2spi.operation.set.SetPrimaryType;
import org.apache.jackrabbit.jcr2spi.operation.set.property.SetPropertyValue;
import org.apache.jackrabbit.jcr2spi.operation.structure.Update;
import org.apache.jackrabbit.jcr2spi.operation.workspace.WorkspaceImport;
...
import org.apache.jackrabbit.spi.commons.name.factory.NameConstants;
import org.apache.jackrabbit.spi.commons.nodetype.storage.NodeTypeStorage;
...
public class WorkspaceManager
    ...
    private final class OperationVisitorImpl implements OperationVisitor {
        ...
        /**
         * @see OperationVisitor#visit(SetTree)
         */
