...
public abstract class ItemDefinitionImpl implements ItemDefinition {
     ...
     */
    public final QItemDefinition itemDef;
     ...
     * @param resolver
     */
    protected ItemDefinitionImpl(QItemDefinition itemDef, NamePathResolver resolver) {
     ...
     * @param resolver
     */
    protected ItemDefinitionImpl(QItemDefinition itemDef, AbstractNodeTypeManager ntMgr, NamePathResolver resolver) {
