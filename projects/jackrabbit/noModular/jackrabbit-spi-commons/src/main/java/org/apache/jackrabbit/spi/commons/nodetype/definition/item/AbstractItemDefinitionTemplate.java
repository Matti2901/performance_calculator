 ...
 */
package org.apache.jackrabbit.spi.commons.nodetype.definition.item;
 ...
 */
public abstract class AbstractItemDefinitionTemplate implements ItemDefinition {
     ...
     * @param resolver
     */
    protected AbstractItemDefinitionTemplate(NamePathResolver resolver) {
     ...
     */
    protected AbstractItemDefinitionTemplate(ItemDefinition def, NamePathResolver resolver) throws ConstraintViolationException {
        this.resolver = resolver;
