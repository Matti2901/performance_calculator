...
import org.apache.jackrabbit.spi.commons.name.match.Matcher;
import org.apache.jackrabbit.spi.commons.name.match.pattern.specific.NamePattern;
import org.apache.jackrabbit.spi.commons.name.match.pattern.specific.RegexPattern;
...
public abstract class Pattern {
    ...
    public abstract Context match(Context input) throws RepositoryException;
    ...
    private static final Pattern ALL_PATTERN = new Pattern() {
       public Context match(Context input) {
    ...
    private static class SelectPattern extends Pattern {
        ...
        public Context match(Context input) throws RepositoryException {
    ...
    public static class RepeatPattern extends Pattern {
    ...
    public static abstract class AbstractNamePattern extends Pattern {
