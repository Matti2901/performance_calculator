 ...
 */
package org.apache.jackrabbit.core.session.operation;
...
import org.apache.jackrabbit.core.session.operation.namespace.PermissionAwareNamespaceRegistry;
...
public class SessionContext implements NamePathResolver {
    ...
    public SessionContext(
        ...
        this.nsRegistry = new PermissionAwareNamespaceRegistry(this);
