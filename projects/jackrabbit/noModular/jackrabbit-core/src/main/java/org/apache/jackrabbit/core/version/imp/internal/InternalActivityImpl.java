...
import org.apache.jackrabbit.core.version.manager.InternalXAVersionManager;
...
public class InternalActivityImpl extends InternalVersionItemImpl implements InternalActivity {
     ...
     * @throws RepositoryException if an error occurs
     */
    public static NodeStateEx create(NodeStateEx parent, Name name, NodeId activityId,
                                     String title)
            throws RepositoryException {
