...
import org.apache.jackrabbit.core.version.manager.impl.DynamicESCFactory;
import org.apache.jackrabbit.core.version.manager.impl.SourcedTarget;
...
import org.apache.jackrabbit.core.version.iterator.VersionItemStateProvider;
import org.apache.jackrabbit.core.version.lock.VersioningLock;
import org.apache.jackrabbit.core.version.imp.internal.InternalActivityImpl;
import org.apache.jackrabbit.core.version.imp.internal.InternalVersionHistoryImpl;
...
import org.apache.jackrabbit.core.version.model.InternalVersionItem;
...
public class InternalVersionManagerImpl extends InternalVersionManagerBase
     ...
     */
    public static final Path SYSTEM_PATH;
     ...
     */
    @Override
    public boolean hasItemReferences(NodeId id)
            throws RepositoryException {
