 ...
 */
package org.apache.jackrabbit.core.version.manager;

import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_ACTIVITY;
import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_ROOTVERSION;
import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_VERSIONHISTORY;
...
import org.apache.jackrabbit.core.version.exception.InconsistentVersioningState;
import org.apache.jackrabbit.core.version.manager.base.WriteOperation;
import org.apache.jackrabbit.core.version.set.NodeStateEx;
import org.apache.jackrabbit.core.version.history.VersionHistoryInfo;
import org.apache.jackrabbit.core.version.imp.internal.*;
import org.apache.jackrabbit.core.version.lock.VersioningLock;
import org.apache.jackrabbit.core.version.model.*;
...
public abstract class InternalVersionManagerBase implements InternalVersionManager {
     ...
     */
    public LocalItemStateManager stateMgr;
...
//-------------------------------------------------------< InternalVersionManager >
    ...
    private WriteOperation startWriteOperation() throws RepositoryException {
        ...
        try {
            stateMgr.edit();
            success = true;
            return new WriteOperation(this, lock);
     ...
     * @throws RepositoryException if an error occurs
     */
    public abstract InternalVersionItem getItem(NodeId id)
            throws RepositoryException;
     ...
     *                             repository.
     */
    public abstract boolean hasItemReferences(NodeId id)
            throws RepositoryException;
