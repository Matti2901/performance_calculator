...
import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_MIXINTYPES;
import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_PRIMARYTYPE;
import static org.apache.jackrabbit.spi.commons.name.factory.NameConstants.JCR_UUID;
...
import org.apache.jackrabbit.core.cache.concurrent.ConcurrentCache;
...
import org.apache.jackrabbit.core.persistence.check.consistency.ConsistencyCheckListener;
import org.apache.jackrabbit.core.persistence.check.consistency.ConsistencyChecker;
import org.apache.jackrabbit.core.persistence.check.consistency.ConsistencyReport;
...
public abstract class AbstractBundlePersistenceManager implements
     ...
     * @return the buffer with the appended data.
     */
    public StringBuffer buildBlobFilePath(StringBuffer buf, PropertyId id,
                                          int i) {
        if (buf == null) {
            buf = new StringBuffer();
        }
