 ...
 */
package org.apache.jackrabbit.core.version.imp.internal;
...
public class InternalVersionHistoryImpl extends InternalVersionItemImpl
     ...
     */
    public synchronized void removeVersion(Name versionName) throws RepositoryException {
     ...
     */
    public synchronized InternalVersion setVersionLabel(Name versionName, Name label, boolean move)
            throws VersionException {
     ...
     * @throws RepositoryException if an error occurs
     */
    public synchronized InternalVersionImpl checkin(
     ...
     * @throws RepositoryException if an error occurs
     */
    public static NodeStateEx create(
