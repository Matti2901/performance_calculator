...
import org.apache.jackrabbit.core.persistence.db.blob.OracleBLOBStore;
...
public class OraclePersistenceManager extends SimpleDbPersistenceManager {
    ...
    public void init(PMContext context) throws Exception {
        ...
        if (!externalBLOBs) {
            blobStore = new OracleBLOBStore(this);
        }
     ...
     */
    public Blob createTemporaryBlob(InputStream in) throws Exception {
        /*
     ...
     */
    public void freeTemporaryBlob(Object blob) throws Exception {
        // blob.freeTemporary();
