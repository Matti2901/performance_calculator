 ...
 */
package org.apache.jackrabbit.server.remoting.davex.json;
...
public class JsonWriter {
    ...
    public void write(Node node, int maxLevels) throws RepositoryException, IOException {
        write(node, 0, maxLevels);
    }

    public void write(Collection<Node> nodes, int maxLevels)
