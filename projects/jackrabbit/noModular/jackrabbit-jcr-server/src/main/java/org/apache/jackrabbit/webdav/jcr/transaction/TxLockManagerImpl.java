...
import org.apache.jackrabbit.webdav.jcr.transaction.txmodel.GlobalTransaction;
import org.apache.jackrabbit.webdav.jcr.transaction.txmodel.LocalTransaction;
import org.apache.jackrabbit.webdav.jcr.transaction.txmodel.Transaction;
import org.apache.jackrabbit.webdav.jcr.transaction.txmodel.TransactionMap;
...
public class TxLockManagerImpl implements TxLockManager {
    ...
    public static Logger log = LoggerFactory.getLogger(TxLockManagerImpl.class);
     ...
     * @param resource
     */
    public static void removeReferences(Transaction tx, TransactionMap responsibleMap,
                                        TransactionResource resource) {
     ...
     * @return JCR session
     */
    public static Session getRepositorySession(TransactionResource resource) throws DavException {
