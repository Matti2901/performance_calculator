...
import org.apache.jackrabbit.spi.commons.nodetype.constraint.CreateConstraint;
        ...
        for (int i = 0; i < pds.length; i++) {
            ...
            if (jcrConstraints != null && jcrConstraints.length > 0) {
                ...
                for (int j=0; j<constraints.length; j++) {
                    constraints[j] = CreateConstraint.create(propDef.getRequiredType(), jcrConstraints[j], resolver);
                }
            }
