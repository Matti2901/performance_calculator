...
import org.apache.commons.compress.harmony.unpack200.bytecode.IByteCodeForm;
...
public class WideForm extends VariableInstructionForm {
     ...
     * (non-Javadoc)
     *
     * @see org.apache.commons.compress.harmony.unpack200.bytecode.ByteCodeForm#setByteCodeOperands(org.apache.commons.
     * compress.harmony.unpack200.bytecode.ByteCode, org.apache.commons.compress.harmony.unpack200.bytecode.OperandTable,
     * org.apache.commons.compress.harmony.unpack200.bytecode.SegmentConstantPool)
     */
    @Override
    public void setByteCodeOperands(final IByteCodeForm byteCode, final OperandManager operandManager, final int codeLength) {
     ...
     */
    protected void setByteCodeOperandsFormat1(final int instruction, final IByteCodeForm byteCode, final OperandManager operandManager, final int codeLength) {
     ...
     * @param codeLength     ignored
     */
    protected void setByteCodeOperandsFormat2(final int instruction, final IByteCodeForm byteCode, final OperandManager operandManager, final int codeLength) {
