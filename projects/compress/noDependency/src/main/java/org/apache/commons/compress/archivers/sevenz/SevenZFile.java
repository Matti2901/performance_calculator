...
public class SevenZFile implements Closeable {
    ...
    public static class Builder extends AbstractStreamBuilder<SevenZFile, Builder> {
        ...
        private int maxMemoryLimitKiB = SevenZFileOptions.MEMORY_LIMIT_IN_KB;
        private boolean useDefaultNameForUnnamedEntries = SevenZFileOptions.USE_DEFAULTNAME_FOR_UNNAMED_ENTRIES;
        private boolean tryToRecoverBrokenArchives = SevenZFileOptions.TRY_TO_RECOVER_BROKEN_ARCHIVES;
        ...
        public Builder setPassword(final char[] password) {
            this.password = password != null ? AES256Utils.utf16Decode(password.clone()) : null;
            return this;
        }
        ...
        public Builder setPassword(final String password) {
            this.password = password != null ? AES256Utils.utf16Decode(password.toCharArray()) : null;
            return this;
        }
    ...
    public SevenZFile(final File file, final char[] password, final SevenZFileOptions options) throws IOException {
        this(newByteChannel(file), // NOSONAR
                file.getAbsolutePath(), AES256Utils.utf16Decode(password), true, options);
    }
    ...
    public SevenZFile(final SeekableByteChannel channel, final String fileName, final char[] password, final SevenZFileOptions options) throws IOException {
        this(channel, fileName, AES256Utils.utf16Decode(password), false, options);
    }
