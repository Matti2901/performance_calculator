...
import org.apache.commons.compress.archivers.zip.ZipUtilTime;
...
public class ArjArchiveEntry implements ArchiveEntry {
    ...
    public Date getLastModifiedDate() {
        final long ts = isHostOsUnix() ? localFileHeader.dateTimeModified * 1000L : ZipUtilTime.dosToJavaTime(0xFFFFFFFFL & localFileHeader.dateTimeModified);
        return new Date(ts);
    }
