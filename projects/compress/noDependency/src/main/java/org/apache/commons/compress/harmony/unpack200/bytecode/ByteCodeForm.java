...
public abstract class ByteCodeForm {
     ...
     */
    public abstract void setByteCodeOperands(IByteCodeForm byteCode, OperandManager operandManager, int codeLength) throws Pack200Exception;
     ...
     */
    public static class NoArgumentForm extends ByteCodeForm {
