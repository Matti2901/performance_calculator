...
import org.apache.commons.compress.harmony.unpack200.bytecode.Segment;
...
public class Archive {
    ...
    public Archive(final InputStream inputStream, final JarOutputStream outputStream) throws IOException {
        this.inputStream = newBoundedInputStream(inputStream);
        this.outputStream = outputStream;
        if (inputStream instanceof FileInputStream) {
            inputPath = Paths.get(readPathString((FileInputStream) inputStream));
        } else {
            inputPath = null;
        }
    ...
    static <T> T readField(final Object object, final String fieldName) {
        try {
    ...
    public static BoundedInputStream newBoundedInputStream(final InputStream inputStream) throws IOException {
