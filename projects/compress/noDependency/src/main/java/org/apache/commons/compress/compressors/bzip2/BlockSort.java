...
final class BlockSort {
    ...
    BlockSort(final Data data) {
        this.quadrant = data.sfmap;
    }

    void blockSort(final Data data, final int last) {
     ...
     * it starts at 0).
     */
    void fallbackSort(final Data data, final int last) {
     ...
     */
    private void mainQSort3(final Data dataShadow, final int loSt, final int hiSt, final int dSt, final int last) {
     ...
     * </p>
     */
    private boolean mainSimpleSort(final Data dataShadow, final int lo, final int hi, final int d, final int lastShadow) {
    ...
    void mainSort(final Data dataShadow, final int lastShadow) {
