 ...
 */
public class ByteCode extends ClassFileEntry implements IByteCodeForm,IByteCode {
     ...
     */
    public void applyByteCodeTargetFixup(final ICodeAttribute codeAttribute) {
