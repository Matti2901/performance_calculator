...
import org.apache.commons.compress.harmony.unpack200.bytecode.SegmentConstantPool;
...
public class IMethodRefForm extends ReferenceForm {
     ...
     * org.apache.commons.compress.harmony.unpack200.bytecode.Segment)
     */
    @Override
    public void setByteCodeOperands(final IByteCodeForm byteCode, final OperandManager operandManager, final int codeLength) throws Pack200Exception {
