...
public class SevenZFileOptions {
     ...
     * </ul>
     */
    public static final SevenZFileOptions DEFAULT = new SevenZFileOptions(MEMORY_LIMIT_IN_KB,
            USE_DEFAULTNAME_FOR_UNNAMED_ENTRIES, TRY_TO_RECOVER_BROKEN_ARCHIVES);
