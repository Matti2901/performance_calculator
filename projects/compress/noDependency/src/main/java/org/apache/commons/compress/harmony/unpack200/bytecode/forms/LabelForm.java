...
public class LabelForm extends ByteCodeForm {
     ...
     * (non-Javadoc)
     *
     * @see org.apache.commons.compress.harmony.unpack200.bytecode.ByteCodeForm#fixUpByteCodeTarget(org.apache.commons.
     * compress.harmony.unpack200.bytecode.ByteCode, org.apache.commons.compress.harmony.unpack200.bytecode.CodeAttribute)
     */
    @Override
    public void fixUpByteCodeTargets(final IByteCodeForm byteCode, final ICodeAttribute codeAttribute) {
        ...
        final int targetValue = codeAttribute.getByteCodeOffsets().get(absoluteInstructionTargetIndex);
        final int sourceValue = codeAttribute.getByteCodeOffsets().get(sourceIndex);
