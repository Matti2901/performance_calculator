...
class ZipUtilTest {
    ...
    @Test
    void testIsDosTime() {
        assertFalse(ZipUtilTime.isDosTime(toLocalInstant("1975-01-31T23:00:00").toEpochMilli()));
        assertTrue(ZipUtilTime.isDosTime(toLocalInstant("1980-01-03T00:00:00").toEpochMilli()));
        assertTrue(ZipUtilTime.isDosTime(toLocalInstant("2097-11-27T00:00:00").toEpochMilli()));
        assertFalse(ZipUtilTime.isDosTime(toLocalInstant("2099-01-01T00:00:00").toEpochMilli()));
        ...
        assertTrue(ZipUtilTime.isDosTime(ZipUtilTime.dosToJavaTime(lowestExpressableDosTime)));
    }
