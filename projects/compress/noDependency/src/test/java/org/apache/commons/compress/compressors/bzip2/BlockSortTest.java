...
class BlockSortTest {
    ...
    private static final class DS {
        ...
        DS(final Data data, final BlockSort s) {
            this.data = data;
            this.s = s;
        }
    }
    ...
    private void assertFixture2Sorted(final Data data) {
        assertFixtureSorted(data, FIXTURE2, FIXTURE2_BWT);
    }

    private void assertFixtureSorted(final Data data) {
        assertFixtureSorted(data, FIXTURE, FIXTURE_BWT);
    }

    private void assertFixtureSorted(final Data data, final byte[] fixture, final byte[] fixtureBwt) {
