...
public class GzipParameters {
     ...
     * 13: Acorn RISCOS.
     */
    static final int OS_ACORN_RISCOS = 13;

    /**
     * 1: Amiga.
     */
    static final int OS_AMIGA = 1;

    /**
     * 5: Atari TOS.
     */
    static final int OS_ATARI_TOS = 5;

    /**
     * 9: CP/M.
     */
    static final int OS_CPM = 9;

    /**
     * 0: FAT.
     */
    static final int OS_FAT = 0;

    /**
     * 6: HPFS filesystem (OS/2, NT).
     */
    static final int OS_HPFS = 6;

    /**
     * 7: Macintosh.
     */
    static final int OS_MACINTOSH = 7;

    /**
     * 11: NTFS filesystem (NT).
     */
    static final int OS_NTFS = 11;

    /**
     * 12: QDOS.
     */
    static final int OS_QDOS = 12;

    /**
     * 10: TOPS-20.
     */
    static final int OS_TOPS_20 = 10;
     ...
     * 255: unknown.
     */
    static final int OS_UNKNOWN = 255;

    /**
     * 4: VM/CMS.
     */
    static final int OS_VM_CMS = 4;

    /**
     * 2: VMS (or OpenVMS).
     */
    static final int OS_VMS = 2;

    /**
     * 8: Z-System.
     */
    static final int OS_Z_SYSTEM = 8;
