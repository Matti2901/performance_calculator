...
import org.apache.commons.compress.archivers.arj.mainheaderparameter.MainParameter;
...
public class ArjArchiveInputStream extends ArchiveInputStream<ArjArchiveEntry> {
    ...
    public ArjArchiveInputStream(final InputStream inputStream, final String charsetName) throws ArchiveException {
        ...
        try {
            ...
            if ((mainHeader.arjFlags & MainParameter.Flags.GARBLED) != 0) {
                throw new ArchiveException("Encrypted ARJ files are unsupported");
            }
            if ((mainHeader.arjFlags & MainParameter.Flags.VOLUME) != 0) {
    ...
    public boolean canReadEntryData(final ArchiveEntry ae) {
        return ae instanceof ArjArchiveEntry && ((ArjArchiveEntry) ae).getMethod() == LocalParameters.Methods.STORED;
    }
    ...
    public ArjArchiveEntry getNextEntry() throws IOException {
        ...
        if (currentLocalFileHeader != null) {
            ...
            currentInputStream = BoundedInputStream.builder()
                    ...
                    .get();
            // @formatter:on
            if (currentLocalFileHeader.method == LocalParameters.Methods.STORED) {
                // @formatter:off
