...
final class BlockSort {
    ...
    BlockSort(final OutputData data) {
        this.quadrant = data.sfmap;
    }

    void blockSort(final OutputData data, final int last) {
     ...
     * it starts at 0).
     */
    void fallbackSort(final OutputData data, final int last) {
     ...
     */
    private void mainQSort3(final OutputData dataShadow, final int loSt, final int hiSt, final int dSt, final int last) {
     ...
     * </p>
     */
    private boolean mainSimpleSort(final OutputData dataShadow, final int lo, final int hi, final int d, final int lastShadow) {
    ...
    void mainSort(final OutputData dataShadow, final int lastShadow) {
