...
import org.apache.commons.compress.archivers.examples.clients.ArchiverFileVisitor;
...
public class Archiver {
    ...
    public void create(final SevenZOutputFile target, final Path directory) throws IOException {
        ...
        Files.walkFileTree(directory, new ArchiverFileVisitor<ArchiveOutputStream<ArchiveEntry>, ArchiveEntry>(null, directory) {
            ...
            @Override
            public FileVisitResult visit(final Path path, final BasicFileAttributes attrs, final boolean isFile) throws IOException {
