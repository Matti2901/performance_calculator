 ...
 */
public final class SubStreamsInfo {

    /**
     * Unpacked size of each unpacked stream.
     */
    public final long[] unpackSizes;

    /**
     * Whether CRC is present for each unpacked stream.
     */
    public final BitSet hasCrc;

    /**
     * CRCs of unpacked streams, if present.
     */
    public final long[] crcs;

    public SubStreamsInfo(final int totalUnpackStreams) {
