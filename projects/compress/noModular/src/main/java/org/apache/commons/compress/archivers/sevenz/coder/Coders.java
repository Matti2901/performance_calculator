 ...
 * under the License.
 */
package org.apache.commons.compress.archivers.sevenz.coder;
...
import org.apache.commons.compress.archivers.sevenz.method.SevenZMethod;
...
public final class Coders {
    ...
    static final class BCJDecoder extends AbstractCoder {
        ...
        @Override
        public InputStream decode(final String archiveName, final InputStream in, final long uncompressedLength, final Coder coder, final byte[] password,
        ...
        @Override
       public OutputStream encode(final OutputStream out, final Object options) {
    ...
    public static final class DeflateDecoder extends AbstractCoder {
    ...
    public static InputStream addDecoder(final String archiveName, final InputStream is, final long uncompressedLength, final Coder coder, final byte[] password,
                                         final int maxMemoryLimitKiB) throws IOException {
    ...
    public static OutputStream addEncoder(final OutputStream out, final SevenZMethod method, final Object options) throws IOException {
    ...
    public static AbstractCoder findByMethod(final SevenZMethod method) {
