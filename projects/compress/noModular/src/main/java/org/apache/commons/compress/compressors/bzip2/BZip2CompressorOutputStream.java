...
public class BZip2CompressorOutputStream extends CompressorOutputStream<OutputStream> implements BZip2Constants {
    ...
    private static void hbMakeCodeLengths(final byte[] len, final int[] freq, final OutputData dat, final int alphaSize, final int maxLen) {
        /*
    ...
    private void generateMTFValues() {
        ...
        final OutputData dataShadow = this.data;
    ...
    private void init() throws IOException {
        ...
        this.data = new OutputData(this.blockSize100k);
