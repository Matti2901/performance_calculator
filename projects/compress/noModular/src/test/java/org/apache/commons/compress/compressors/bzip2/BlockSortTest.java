...
class BlockSortTest {
    ...
    private static final class DS {
        ...
        DS(final OutputData data, final BlockSort s) {
            this.data = data;
            this.s = s;
        }
    }
    ...
    private void assertFixture2Sorted(final OutputData data) {
        assertFixtureSorted(data, FIXTURE2, FIXTURE2_BWT);
    }

    private void assertFixtureSorted(final OutputData data) {
        assertFixtureSorted(data, FIXTURE, FIXTURE_BWT);
    }

    private void assertFixtureSorted(final OutputData data, final byte[] fixture, final byte[] fixtureBwt) {
    ...
    private DS setUpFixture(final byte[] fixture) {
        final OutputData data = new OutputData(1);
