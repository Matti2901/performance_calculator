...
* [#942] (https://github.com/zeromq/jeromq/pull/942)
  `zmq.core.Ctx` can now be provided a thread factory, that can used to tweaks threads. The main purpose of this is to be able to 
...
* Also adding a check that prevent modifications of some settings once they have been used by `zmq.core.Ctx` initialisation.
...
* [#936] (https://github.com/zeromq/jeromq/pull/936)
  ...
  `org.zeromq.ZSocket` and `org.zeromq.ZMQ.Socket` can now read and write `zmq.core.Msg` directly.
...
* [#684](https://github.com/zeromq/jeromq/pull/684): Fixed a bug where
  `zmq.core.Msg.getBytes` was writing to an internal buffer instead of the given
  buffer.
...
* Remove global errno
* expose special purpose raw zmq.core.SocketBase
