...
import zmq.io.net.ipc.IpcAddressMask;
...
public class Options
{
    ...
    public int recvTimeout = ZMQ.DEFAULT_RECV_TIMEOUT;
    public int sendTimeout = ZMQ.DEFAULT_SEND_TIMEOUT;
    ...
    // IPC accept() filters
    final List<IpcAddressMask> ipcAcceptFilters = new ArrayList<>();
