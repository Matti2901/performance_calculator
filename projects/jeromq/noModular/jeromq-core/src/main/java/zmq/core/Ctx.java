...
import zmq.IMailbox;
import zmq.Mailbox;
import zmq.core.ctxdef.ChannelForwardHolder;
import zmq.core.ctxdef.Side;
...
public class Ctx
{
    ...
    public void terminate()
    {
        ...
        if (!starting.get()) {
            ...
            assert (cmd.type == CommandType.DONE) : cmd;
   ...
   /**
                                      ...
                                      Side side)
    {
        ...
        if (side == Side.BIND) {
            Command cmd = new Command(null, CommandType.BIND, pendingConnection.bindPipe);
     ...
     */
    public int forwardChannel(SelectableChannel channel)
    {
     ...
     * @return
     */
    public SelectableChannel getForwardedChannel(Integer handle)
    {
        cleanForwarded();
