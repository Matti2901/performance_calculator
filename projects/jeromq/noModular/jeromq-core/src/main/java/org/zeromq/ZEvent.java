...
public class ZEvent
{
     ...
     */
    public interface ZEventConsummer extends EventConsummer
    {
        void consume(ZEvent ev);

        default void consume(zmq.core.event.Event event)
        {
    ...
    private ZEvent(zmq.core.event.Event event, Function<Object, SelectableChannel> getResolveChannel)
    {
