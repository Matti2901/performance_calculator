...
import zmq.exception.ZError.CtxTerminatedException;
import zmq.io.coder.decoder.IDecoder;
import zmq.io.coder.encoder.IEncoder;
import zmq.io.mechanism.Mechanisms;
import zmq.io.net.SelectorProviderChooser;
import zmq.msg.MsgAllocator;
import zmq.util.Draft;
import zmq.util.value.Z85;
...
public class ZMQ
{
     ...
     */
    public static final int SNDMORE = zmq.core.ZMQ.ZMQ_SNDMORE;

    // Values for flags in Socket's send and recv functions.
    /**
     * Socket flag to indicate a nonblocking send or recv mode.
     */
    public static final int DONTWAIT = zmq.core.ZMQ.ZMQ_DONTWAIT;
    public static final int NOBLOCK  = zmq.core.ZMQ.ZMQ_DONTWAIT;
     ...
     */
    @Deprecated
    public static final int PAIR = zmq.core.ZMQ.ZMQ_PAIR;

    /**
     * @deprecated use {@link SocketType#PUB} instead
     */
    @Deprecated
    public static final int PUB = zmq.core.ZMQ.ZMQ_PUB;
    /**
     * @deprecated use {@link SocketType#SUB} instead
     */
    @Deprecated
    public static final int SUB = zmq.core.ZMQ.ZMQ_SUB;

    /**
     * @deprecated use {@link SocketType#REQ} instead
     */
    @Deprecated
    public static final int REQ = zmq.core.ZMQ.ZMQ_REQ;

    /**
     * @deprecated use {@link SocketType#REP} instead
     */
    @Deprecated
    public static final int REP = zmq.core.ZMQ.ZMQ_REP;

    /**
     * @deprecated use {@link SocketType#DISH} instead
     */
    @Deprecated
    public static final int DISH = zmq.core.ZMQ.ZMQ_DISH;

    /**
     * @deprecated use {@link SocketType#RADIO} instead
     */
    @Deprecated
    public static final int RADIO = zmq.core.ZMQ.ZMQ_RADIO;

    /**
     * @deprecated use {@link SocketType#DEALER} instead
     */
    @Deprecated
    public static final int DEALER = zmq.core.ZMQ.ZMQ_DEALER;
    /**
    ...
    @Deprecated
    public static final int ROUTER = zmq.core.ZMQ.ZMQ_ROUTER;
    /**
    ...
    @Deprecated
    public static final int PULL = zmq.core.ZMQ.ZMQ_PULL;

    @Deprecated
    public static final int PUSH = zmq.core.ZMQ.ZMQ_PUSH;

    @Deprecated
    public static final int XPUB = zmq.core.ZMQ.ZMQ_XPUB;

    @Deprecated
    public static final int XSUB = zmq.core.ZMQ.ZMQ_XSUB;

    @Deprecated
    public static final int STREAM     = zmq.core.ZMQ.ZMQ_STREAM;
    /**
     * Flag to specify a STREAMER device.
     */
    @Deprecated
    public static final int STREAMER   = zmq.core.ZMQ.ZMQ_STREAMER;
    /**
     * Flag to specify a FORWARDER device.
     */
    @Deprecated
    public static final int FORWARDER  = zmq.core.ZMQ.ZMQ_FORWARDER;
    /**
     * Flag to specify a QUEUE device.
     */
    @Deprecated
    public static final int QUEUE      = zmq.core.ZMQ.ZMQ_QUEUE;
    /**
     ...
     */
    public static final int EVENT_CONNECTED          = zmq.core.ZMQ.ZMQ_EVENT_CONNECTED;
    /**
     ...
     * no meaning.
     */
    public static final int EVENT_CONNECT_DELAYED    = zmq.core.ZMQ.ZMQ_EVENT_CONNECT_DELAYED;
    /**
     ...
     */
    public static final int EVENT_CONNECT_RETRIED    = zmq.core.ZMQ.ZMQ_EVENT_CONNECT_RETRIED;
    /**
     ...
     */
    public static final int EVENT_LISTENING          = zmq.core.ZMQ.ZMQ_EVENT_LISTENING;
    /**
     ...
     */
    public static final int EVENT_BIND_FAILED        = zmq.core.ZMQ.ZMQ_EVENT_BIND_FAILED;
    /**
     ...
     * the accepted socket.
     */
    public static final int EVENT_ACCEPTED           = zmq.core.ZMQ.ZMQ_EVENT_ACCEPTED;
    /**
     ...
     */
    public static final int EVENT_ACCEPT_FAILED      = zmq.core.ZMQ.ZMQ_EVENT_ACCEPT_FAILED;
    /**
     ...
     */
    public static final int EVENT_CLOSED             = zmq.core.ZMQ.ZMQ_EVENT_CLOSED;
    /**
     ...
     */
    public static final int EVENT_CLOSE_FAILED       = zmq.core.ZMQ.ZMQ_EVENT_CLOSE_FAILED;
    /**
     ...
     * the socket.
     */
    public static final int EVENT_DISCONNECTED       = zmq.core.ZMQ.ZMQ_EVENT_DISCONNECTED;
    /**
     * EVENT_MONITOR_STOPPED: monitor has been stopped.
     * The EVENT_MONITOR_STOPPED event triggers when the monitor for a socket is
     * stopped.
     */
    public static final int EVENT_MONITOR_STOPPED    = zmq.core.ZMQ.ZMQ_EVENT_MONITOR_STOPPED;
    /**
     ...
     */
    public static final int EVENT_HANDSHAKE_PROTOCOL = zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_PROTOCOL;
    /**
     * EVENT_ALL: all events known.
     * The EVENT_ALL constant can be used to set up a monitor for all known events.
     */
    public static final int EVENT_ALL                = zmq.core.ZMQ.ZMQ_EVENT_ALL;

    /**
     * Unspecified system errors during handshake. Event value is an errno.
     */
    public static final int HANDSHAKE_FAILED_NO_DETAIL   = zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL;

    /**
     * Handshake complete successfully with successful authentication (if
     *  enabled). Event value is unused.
     */
    public static final int HANDSHAKE_SUCCEEDED      = zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_SUCCEEDED;

    /**
     *   Protocol errors between ZMTP peers or between server and ZAP handler.
     *  Event value is one of ZMQ_PROTOCOL_ERROR_*
     */
    public static final int HANDSHAKE_FAILED_PROTOCOL = zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL;
    /**
     *   Failed authentication requests. Event value is the numeric ZAP status
     *  code, i.e. 300, 400 or 500.
     */
    public static final int HANDSHAKE_FAILED_AUTH     = zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_AUTH;

    public static final byte[] MESSAGE_SEPARATOR = zmq.core.ZMQ.MESSAGE_SEPARATOR;

    public static final byte[] SUBSCRIPTION_ALL = zmq.core.ZMQ.SUBSCRIPTION_ALL;

    public static final byte[] PROXY_PAUSE     = zmq.core.ZMQ.PROXY_PAUSE;
    public static final byte[] PROXY_RESUME    = zmq.core.ZMQ.PROXY_RESUME;
    public static final byte[] PROXY_TERMINATE = zmq.core.ZMQ.PROXY_TERMINATE;

    public static final Charset CHARSET = zmq.core.ZMQ.CHARSET;
    ...
    {
        return zmq.core.ZMQ.proxy(frontend.base, backend.base, null);
    }
    ...
    {
        return zmq.core.ZMQ.proxy(frontend.base, backend.base, capture != null ? capture.base : null);
    }

    public static boolean proxy(Socket frontend, Socket backend, Socket capture, Socket control)
    {
        return zmq.core.ZMQ.proxy(
                             frontend.base,
                             backend.base,
    ...
    {
        zmq.poll.item.PollItem[] pollItems = new zmq.poll.item.PollItem[count];
        for (int i = 0; i < count; i++) {
            pollItems[i] = items[i].base;
        }

        return zmq.core.ZMQ.poll(selector, pollItems, count, timeout);
    }
    ...
    {
        return zmq.core.ZMQ.ZMQ_VERSION_MAJOR;
    }
    ...
    {
        return zmq.core.ZMQ.ZMQ_VERSION_MINOR;
    }
    ...
    {
        return zmq.core.ZMQ.ZMQ_VERSION_PATCH;
    }
    ...
    {
        return zmq.core.ZMQ.makeVersion(zmq.core.ZMQ.ZMQ_VERSION_MAJOR, zmq.core.ZMQ.ZMQ_VERSION_MINOR, zmq.core.ZMQ.ZMQ_VERSION_PATCH);
    }
    ...
    {
        return zmq.core.ZMQ.makeVersion(major, minor, patch);
    }
    ...
    {
        return "" + zmq.core.ZMQ.ZMQ_VERSION_MAJOR + "." + zmq.core.ZMQ.ZMQ_VERSION_MINOR + "." + zmq.core.ZMQ.ZMQ_VERSION_PATCH;
    }

    public static void msleep(long millis)
    {
        zmq.core.ZMQ.msleep(millis);
    }

    public static void sleep(long seconds)
    {
        zmq.core.ZMQ.sleep(seconds);
    }

    public static void sleep(long amount, TimeUnit unit)
    {
        zmq.core.ZMQ.sleep(amount, unit);
    }
    ...
    public static class Context implements Closeable
    {
        ...
        {
            ctx = zmq.core.ZMQ.init(ioThreads);
        }
        ...
        {
            return ctx.get(zmq.core.ZMQ.ZMQ_IO_THREADS);
        }
        ...
        {
            return ctx.set(zmq.core.ZMQ.ZMQ_IO_THREADS, ioThreads);
        }
        ...
        {
            return ctx.get(zmq.core.ZMQ.ZMQ_MAX_SOCKETS);
        }
        ...
        {
            return ctx.set(zmq.core.ZMQ.ZMQ_MAX_SOCKETS, maxSockets);
        }
        ...
        {
            return ctx.get(zmq.core.ZMQ.ZMQ_BLOCKY) != 0;
        }

        public boolean setBlocky(boolean block)
        {
            return ctx.set(zmq.core.ZMQ.ZMQ_BLOCKY, block ? 1 : 0);
        }

        public boolean isIPv6()
        {
            return ctx.get(zmq.core.ZMQ.ZMQ_IPV6) != 0;
        }
        ...
        {
            return ctx.set(zmq.core.ZMQ.ZMQ_IPV6, ipv6 ? 1 : 0);
        }
    ...
    public static class Socket implements Closeable
    {
         ...
         *
         * @return raw zmq.core.SocketBase
         */
        ...
        public int getType()
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TYPE);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_LINGER);
        }
        ...
        {
            return base.setSocketOpt(zmq.core.ZMQ.ZMQ_LINGER, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RECONNECT_IVL);
        }
        ...
        {
            return base.setSocketOpt(zmq.core.ZMQ.ZMQ_RECONNECT_IVL, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_BACKLOG);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_BACKLOG, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_HANDSHAKE_IVL);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_IVL);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_TIMEOUT);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_TTL);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(zmq.core.ZMQ.ZMQ_HEARTBEAT_CONTEXT);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HANDSHAKE_IVL, maxHandshakeIvl);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_IVL, heartbeatIvl);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_TIMEOUT, heartbeatTimeout);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_TTL, heartbeatTtl);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HEARTBEAT_CONTEXT, pingContext);
        }
        ...
        public int getTos()
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TOS);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_TOS, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RECONNECT_IVL_MAX);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_RECONNECT_IVL_MAX, value);
        }
        ...
        {
            return (Long) base.getSocketOptx(zmq.core.ZMQ.ZMQ_MAXMSGSIZE);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_MAXMSGSIZE, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_SNDHWM);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SNDHWM, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RCVHWM);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_RCVHWM, value);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CONFLATE, conflate);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_CONFLATE) != 0;
        }
        ...
        {
            return (Long) base.getSocketOptx(zmq.core.ZMQ.ZMQ_AFFINITY);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_AFFINITY, value);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(zmq.core.ZMQ.ZMQ_IDENTITY);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_IDENTITY, identity);
        }
        ...
        public long getRate()
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RATE);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RECOVERY_IVL);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_REQ_CORRELATE, correlate);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_REQ_RELAXED, relaxed);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_MULTICAST_HOPS);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RCVTIMEO);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_RCVTIMEO, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_SNDTIMEO);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SNDTIMEO, value);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_CNT, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_CNT);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_SNDBUF);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SNDBUF, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RCVBUF);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_RCVBUF, value);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_RCVMORE) == 1;
        }
        ...
        {
            return (SelectableChannel) base.getSocketOptx(zmq.core.ZMQ.ZMQ_FD);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_EVENTS);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_UNSUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_ENCODER, cls);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_DECODER, cls);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD, threshold);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_MSG_ALLOCATOR, allocator);
        }
        ...
        {
            return base.setSocketOpt(zmq.core.ZMQ.ZMQ_SELECTOR_PROVIDERCHOOSER, chooser);
        }
        ...
        {
            return (SelectorProviderChooser) base.getSocketOptx(zmq.core.ZMQ.ZMQ_SELECTOR_PROVIDERCHOOSER);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CONNECT_RID, rid);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_ROUTER_RAW, raw);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_PROBE_ROUTER, probe);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_ROUTER_MANDATORY, mandatory);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_ROUTER_HANDOVER, handover);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_XPUB_VERBOSE, verbose);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_XPUB_NODROP, noDrop);
        }

        public boolean setXpubManual(boolean manual)
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_XPUB_MANUAL, manual);
        }

        public boolean setXpubVerboser(boolean verboser)
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_XPUB_VERBOSER, verboser);
        }
        ...
        public boolean isIPv6()
        {
            return (Boolean) base.getSocketOptx(zmq.core.ZMQ.ZMQ_IPV6);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_IPV6, v6);
        }
        ...
        {
            return base.getSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_TCP_KEEPALIVE, optVal);
        }
        ...
        {
            return (boolean) base.getSocketOptx(zmq.core.ZMQ.ZMQ_IMMEDIATE);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_IMMEDIATE, value);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SOCKS_PROXY, proxy);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_SOCKS_PROXY);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_LAST_ENDPOINT);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_ZAP_DOMAIN, domain);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_ZAP_DOMAIN);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_SELFADDR_PROPERTY_NAME);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_SELFADDR_PROPERTY_NAME, recordName);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_PLAIN_SERVER, server);
        }
        ...
        {
            return (Boolean) base.getSocketOptx(zmq.core.ZMQ.ZMQ_PLAIN_SERVER);
        }
        ...
        {
            return base.setSocketOpt(zmq.core.ZMQ.ZMQ_PLAIN_USERNAME, username);
        }
        ...
        {
            return base.setSocketOpt(zmq.core.ZMQ.ZMQ_PLAIN_PASSWORD, password);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_PLAIN_USERNAME);
        }
        ...
        {
            return (String) base.getSocketOptx(zmq.core.ZMQ.ZMQ_PLAIN_PASSWORD);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CURVE_SERVER, server);
        }
        ...
        {
            return (boolean) base.getSocketOptx(zmq.core.ZMQ.ZMQ_CURVE_SERVER);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CURVE_PUBLICKEY, key);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CURVE_SERVERKEY, key);
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_CURVE_SECRETKEY, key);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(zmq.core.ZMQ.ZMQ_CURVE_PUBLICKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(zmq.core.ZMQ.ZMQ_CURVE_SERVERKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(zmq.core.ZMQ.ZMQ_CURVE_SECRETKEY);
        }
        ...
        {
            return Mechanism.find((Mechanisms) base.getSocketOptx(zmq.core.ZMQ.ZMQ_MECHANISM));
        }
        ...
        {
            return setSocketOpt(zmq.core.ZMQ.ZMQ_HELLO_MSG, helloMsg);
        }
        ...
        {
            return sendMsg(msg, zmq.core.ZMQ.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data.getBytes(CHARSET), zmq.core.ZMQ.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data, zmq.core.ZMQ.ZMQ_SNDMORE);
        }
        ...
        public boolean send(byte[] data, int off, int length, int flags)
        {
            ...
            zmq.core.Msg msg = new zmq.core.Msg(copy);
            if (base.send(msg, flags)) {
                return true;
            }
        ...
        {
            zmq.core.Msg msg = base.recv(flags);
        ...
        {
            zmq.core.Msg msg = base.recv(flags, cancellationToken.canceled);
        ...
        protected void mayRaise()
        {
            ...
            if (errno != 0 && errno != zmq.exception.ZError.EAGAIN) {
    ...
    public static class Poller implements Closeable
    {
         ...
         */
        public static final int POLLIN  = zmq.core.ZMQ.ZMQ_POLLIN;
        /**
         ...
         */
        public static final int POLLOUT = zmq.core.ZMQ.ZMQ_POLLOUT;
        /**
         * For standard sockets, this flag is passed through {@link zmq.core.ZMQ#poll(Selector, zmq.poll.item.PollItem[], long)} to the underlying poll() system call
         * and generally means that some sort of error condition is present on the socket specified by fd.
         * <br>
         * For ØMQ sockets this flag has no effect if set in events, and shall never be returned in revents by {@link zmq.core.ZMQ#poll(Selector, zmq.poll.item.PollItem[], long)}.
         */
        public static final int POLLERR = zmq.core.ZMQ.ZMQ_POLLERR;
        ...
        public int poll(long tout)
        {
            ...
            zmq.poll.item.PollItem[] pollItems = new zmq.poll.item.PollItem[items.size()];
            ...
            try {
                return zmq.core.ZMQ.poll(selector, pollItems, items.size(), tout);
            }
    ...
    {
        private final zmq.poll.item.PollItem base;
        private final Socket            socket;

        public PollItem(Socket socket, int ops)
        {
            this.socket = socket;
            base = new zmq.poll.item.PollItem(socket.base, ops);
        }

        public PollItem(SelectableChannel channel, int ops)
        {
            base = new zmq.poll.item.PollItem(channel, ops);
            socket = null;
        }

        final zmq.poll.item.PollItem base()
        {
            return base;
        }
    ...
    public static class Event
    {
        ...
        {
            zmq.core.event.Event e = zmq.core.event.Event.read(socket.base, flags);
            if (e == null) {
                return null;
            }
            Object resolvedValue;
            switch (e.event) {
            case zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL:
                resolvedValue = ZMonitor.ProtocolCode.findByCode((Integer) e.arg);
                break;
            case zmq.core.ZMQ.ZMQ_EVENT_CLOSE_FAILED:
            case zmq.core.ZMQ.ZMQ_EVENT_ACCEPT_FAILED:
            case zmq.core.ZMQ.ZMQ_EVENT_BIND_FAILED:
            case zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL:
                resolvedValue = Error.findByCode((Integer) e.arg);
                break;
            case zmq.core.ZMQ.ZMQ_EVENT_CONNECTED:
            case zmq.core.ZMQ.ZMQ_EVENT_LISTENING:
            case zmq.core.ZMQ.ZMQ_EVENT_ACCEPTED:
            case zmq.core.ZMQ.ZMQ_EVENT_CLOSED:
            case zmq.core.ZMQ.ZMQ_EVENT_DISCONNECTED:
                resolvedValue = e.getChannel(socket.base);
                break;
            case zmq.core.ZMQ.ZMQ_EVENT_CONNECT_DELAYED:
            case zmq.core.ZMQ.ZMQ_EVENT_HANDSHAKE_SUCCEEDED:
            case zmq.core.ZMQ.ZMQ_EVENT_MONITOR_STOPPED:
                resolvedValue = null;
                break;
            default:
                resolvedValue = e.arg;
