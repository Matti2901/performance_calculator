...
public final class ZTimer
{
     ...
     * @deprecated use {@link org.zeromq.timer.Timer} instead
     */
    @Deprecated
    public static final class Timer
    {
        private final org.zeromq.timer.Timer delegate;

        Timer(org.zeromq.timer.Timer delegate)
        {
     ...
     * @deprecated use {@link org.zeromq.timer.Timer#setInterval(long)} instead
     */
    @Deprecated
     ...
     * @deprecated use {@link org.zeromq.timer.Timer#reset()} instead
     */
    @Deprecated
     ...
     * @deprecated use {@link org.zeromq.timer.Timer#cancel()} instead
     */
    @Deprecated
