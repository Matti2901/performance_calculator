...
import zmq.io.net.ipc.connector.IpcConnecter;
import zmq.io.net.ipc.listener.IpcListener;
...
public class IpcNetworkProtocolProvider implements NetworkProtocolProvider<UnixDomainSocketAddress>
{
    ...
    {
        zmq.io.net.ipc.connector.IpcConnecter connecter = new IpcConnecter(ioThread, session, options, addr, delayedStart);
