...
public class TestZMQ
{
    ...
    public void testBindSameAddress() throws IOException
    {
        ...
        try {
            ...
            assertEquals(e.getErrorCode(), ZError.Error.EADDRINUSE.getCode());
            throw e;
        }
        finally {
            socket1.close();
    ...
    public void testSocketSendRecvPicture()
    {
        ...
        assertThat(objects[5], is(equalTo("ABC".getBytes(ZMQUtilConstant.CHARSET))));
    ...
    public void testSocketSendRecvBinaryPicture()
    {
        ...
        assertThat(objects[6], is(equalTo("ABC".getBytes(ZMQUtilConstant.CHARSET))));
