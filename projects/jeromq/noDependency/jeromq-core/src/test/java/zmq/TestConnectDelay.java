...
public class TestConnectDelay
{
    ...
    public void testConnectDelay2() throws Exception
    {
        ...
        // Set the key flag
        rc = ZMQ.setSocketOption(from, ZMQUtilConstant.ZMQ_DELAY_ATTACH_ON_CONNECT, true);
        assertThat(rc, is(true));
    ...
    public void testConnectDelay3() throws Exception
    {
        ...
        ZMQ.setSocketOption(frontend, ZMQUtilConstant.ZMQ_DELAY_ATTACH_ON_CONNECT, true);
