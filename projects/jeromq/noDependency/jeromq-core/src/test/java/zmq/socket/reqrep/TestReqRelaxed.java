...
public class TestReqRelaxed
{
    ...
    public void testReqRelaxed()
    {
        ...
        rc = req.setSocketOpt(ZMQUtilConstant.ZMQ_REQ_CORRELATE, true);
        assertThat(rc, is(true));
        rc = req.setSocketOpt(ZMQUtilConstant.ZMQ_REQ_RELAXED, true);
        assertThat(rc, is(true));
        ...
        for (int idx = 0; idx < services; ++idx) {
            ...
            rc = req.setSocketOpt(ZMQUtilConstant.ZMQ_RCVTIMEO, 500);
            assertThat(rc, is(true));
    ...
    public void testIssueLibzmq1965()
    {
        ...
        req = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_REQ);
        assertThat(req, notNullValue());
    ...
    private void bounce(SocketBase socket)
    {
        ...
        do {
            ...
            more = ZMQ.getSocketOption(socket, ZMQUtilConstant.ZMQ_RCVMORE) > 0;

            socket.send(msg, more ? ZMQUtilConstant.ZMQ_SNDMORE : 0);
        } while (more);
    }
}
