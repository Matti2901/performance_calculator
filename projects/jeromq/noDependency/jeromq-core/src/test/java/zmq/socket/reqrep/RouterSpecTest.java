...
public class RouterSpecTest extends AbstractSpecTest
{
    ...
    public void testFairQueueIn()
    {
        ...
        for (String bindAddress : binds) {
            ...
            // strategy.
            fairQueueIn(ctx, bindAddress, ZMQUtilConstant.ZMQ_ROUTER, ZMQUtilConstant.ZMQ_DEALER);
        }
    ...
    private void fairQueueIn(Ctx ctx, String address, int bindType, int connectType)
    {
        ...
        address = (String) ZMQ.getSocketOptionExt(receiver, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
        ...
        for (int peer = 0; peer < services; ++peer) {
            ...
            rc = ZMQ.setSocketOption(sender, ZMQUtilConstant.ZMQ_IDENTITY, "A" + peer);
            assertThat(rc, is(true));
        ...
        for (int peer = 0; peer < services; ++peer) {
            ...
            sum.remove(new String(msg.data(), ZMQUtilConstant.CHARSET));
            recvSeq(receiver, "M");
        }
