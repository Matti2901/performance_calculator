...
public class SecurityPlainTest
{
    ...
    private Boolean runTest(boolean withzap, Function<PlainTestContext, Boolean> tested) throws InterruptedException
    {
        ...
        Runnable configurator = () -> {
            ...
            ZMQ.setSocketOption(testCtx.server, ZMQUtilConstant.ZMQ_PLAIN_SERVER, true);
        };
    ...
    public boolean runValid(PlainTestContext tctxt)
    {
        ...
        String host = (String) ZMQ.getSocketOptionExt(tctxt.server, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
        ZMQ.setSocketOption(tctxt.client, ZMQUtilConstant.ZMQ_PLAIN_USERNAME, tctxt.user);
        ZMQ.setSocketOption(tctxt.client, ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, tctxt.password);
    ...
    public void testZapInverted() throws InterruptedException
    {
        ...
        Boolean status = runTest(false, tctxt -> {
            ...
            String host = (String) ZMQ.getSocketOptionExt(tctxt.client, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
    ...
    public void testBothServer() throws InterruptedException
    {
        ...
        Boolean status = runTest(true, tctxt -> {
            ...
            String host = (String) ZMQ.getSocketOptionExt(tctxt.server, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
            ZMQ.setSocketOption(tctxt.client, ZMQUtilConstant.ZMQ_PLAIN_SERVER, true);
    ...
    public void testFailedLoginZap() throws InterruptedException
    {
        ...
        Boolean status = runTest(true, tctxt -> {
            ...
            String host = (String) ZMQ.getSocketOptionExt(tctxt.server, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
            ZMQ.setSocketOption(tctxt.client, ZMQUtilConstant.ZMQ_PLAIN_USERNAME, "wronguser");
            ZMQ.setSocketOption(tctxt.client, ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, "wrongpass");
    ...
    public void inconsistent1()
    {
        MechanismTester.checkOptions(Mechanisms.PLAIN, opt -> {
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_USERNAME, null);
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, "plainPassword");
        });
    }
    ...
    {
        MechanismTester.checkOptions(Mechanisms.PLAIN, opt -> {
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_USERNAME, "plainUsername");
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, null);
        });
    }
    ...
    {
        MechanismTester.checkOptions(Mechanisms.PLAIN, opt -> {
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_USERNAME, String.format("%256d", 1));
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, "plainPassword");
        });
    }
    ...
    public void inconsistent4()
    {
        MechanismTester.checkOptions(Mechanisms.PLAIN, opt -> {
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_USERNAME, "plainUsername");
            opt.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, String.format("%256d", 1));
        });
    }
