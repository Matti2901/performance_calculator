...
public class StreamEngineTest
{
    ...
    public void testEncoderFlipIssue520()
    {
        ...
        SocketBase sender = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PUSH);
        assertThat(sender, notNullValue());

        boolean rc = ZMQ.setSocketOption(sender, ZMQUtilConstant.ZMQ_IMMEDIATE, false);
        ...
        addr = (String) ZMQ.getSocketOptionExt(receiver, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
