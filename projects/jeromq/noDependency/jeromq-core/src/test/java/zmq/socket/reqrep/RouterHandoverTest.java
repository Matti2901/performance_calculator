...
public class RouterHandoverTest
{
    ...
    public void testRouterHandover()
    {
        ...
        ZMQ.setSocketOption(router, ZMQUtilConstant.ZMQ_ROUTER_HANDOVER, 1);
        assertThat(router, notNullValue());

        // Create dealer called "X" and connect it to our router
        SocketBase dealerOne = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_DEALER);
        assertThat(dealerOne, notNullValue());

        ZMQ.setSocketOption(dealerOne, ZMQUtilConstant.ZMQ_IDENTITY, "X");
        ...
        SocketBase dealerTwo = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_DEALER);
        assertThat(dealerTwo, notNullValue());

        ZMQ.setSocketOption(dealerTwo, ZMQUtilConstant.ZMQ_IDENTITY, "X");
        ...
        rc = ZMQ.send(router, "X", ZMQUtilConstant.ZMQ_SNDMORE);
        assertThat(rc, is(1));
        ...
        msg = ZMQ.recv(dealerOne, ZMQUtilConstant.ZMQ_DONTWAIT);
