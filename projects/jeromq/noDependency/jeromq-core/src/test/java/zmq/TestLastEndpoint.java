...
public class TestLastEndpoint
{
    static void bindAndVerify(SocketBase s, String endpoint)
    {
        ...
        String stest = (String) ZMQ.getSocketOptionExt(s, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
    ...
    public void testLastEndpoint() throws IOException
    {
        ...
        SocketBase sb = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_ROUTER);
    ...
    public void testLastEndpointWildcardIpc()
    {
        ...
        SocketBase socket = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_ROUTER);
        assertThat(socket, notNullValue());

        boolean brc = ZMQ.bind(socket, "ipc://*");
        assertThat(brc, is(true));

        String stest = (String) ZMQ.getSocketOptionExt(socket, ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
