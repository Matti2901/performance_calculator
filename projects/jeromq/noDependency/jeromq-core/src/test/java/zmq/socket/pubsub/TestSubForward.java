...
public class TestSubForward
{
    ...
    public void testSubForward() throws IOException
    {
        ...
        SocketBase xpubBind = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_XPUB);
        assertThat(xpubBind, notNullValue());

        boolean rc = ZMQ.bind(xpubBind, "tcp://127.0.0.1:" + port1);

        SocketBase xsubBind = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_XSUB);
        ...
        //  Create a publisher
        SocketBase pubConnect = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PUB);
