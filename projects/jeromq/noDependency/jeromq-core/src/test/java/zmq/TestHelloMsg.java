...
public class TestHelloMsg
{
    ...
    public void testTcp() throws Exception
    {
        ...
        SocketBase router = ZMQ.socket(context, ZMQUtilConstant.ZMQ_ROUTER);
        assertThat(router, notNullValue());

        // set router socket options
        boolean rc = ZMQ.setSocketOption(router, ZMQUtilConstant.ZMQ_HELLO_MSG, "H");
        ...
        // create a dealer
        SocketBase dealer = ZMQ.socket(context, ZMQUtilConstant.ZMQ_DEALER);
    ...
    public void testInprocLateBind()
    {
        ...
        // Create a server
        SocketBase server = ZMQ.socket(context, ZMQUtilConstant.ZMQ_DEALER);
        assertThat(server, notNullValue());

        // set server socket options
        boolean rc = ZMQ.setSocketOption(server, ZMQUtilConstant.ZMQ_HELLO_MSG, "W");
        assertThat(rc, is(true));

        // create a client
        SocketBase client = ZMQ.socket(context, ZMQUtilConstant.ZMQ_DEALER);
        assertThat(client, notNullValue());
        rc = ZMQ.setSocketOption(client, ZMQUtilConstant.ZMQ_HELLO_MSG, "H");
        assertThat(rc, is(true));
