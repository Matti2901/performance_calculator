...
public class CustomEncoderTest
{
    ...
    static class CustomEncoder extends EncoderBase
    {
        ...
        private void readBody()
        {
            ...
            header.clear();
            header.put("HEADER".getBytes(ZMQUtilConstant.CHARSET));
    ...
    public void testCustomEncoder()
    {
        ...
        Msg msg = new Msg("12345678901234567890".getBytes(ZMQUtilConstant.CHARSET));
        ...
        assertThat(new String(data, 0, 6, ZMQUtilConstant.CHARSET), is("HEADER"));
        assertThat((int) data[9], is(20));
        assertThat(new String(data, 10, 20, ZMQUtilConstant.CHARSET), is("12345678901234567890"));
    }
    ...
    public void testAssignCustomEncoder()
    {
        ...
        SocketBase socket = ctx.createSocket(ZMQUtilConstant.ZMQ_PAIR);

        boolean rc = socket.setSocketOpt(ZMQUtilConstant.ZMQ_ENCODER, CustomEncoder.class);
    ...
    public void testAssignWrongCustomEncoder()
    {
        ...
        try {
            socket.setSocketOpt(ZMQUtilConstant.ZMQ_ENCODER, WrongEncoder.class);
        }
        finally {
            ZMQ.close(socket);
            ZMQ.term(ctx);
