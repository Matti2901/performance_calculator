...
public class TestPairTcp
{
    ...
    public void testPairTcp() throws IOException
    {
        ...
        SocketBase sb = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        assertThat(sb, notNullValue());
        boolean brc = ZMQ.bind(sb, "tcp://127.0.0.1:" + port);
        assertThat(brc, is(true));

        SocketBase sc = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
    ...
    public void testPairConnectSecondClientIssue285()
    {
        ...
        Ctx ctx = ZMQ.init(1);
        assertThat(ctx, notNullValue());
        SocketBase bind = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        ...
        SocketBase first = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        ...
        SocketBase second = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        ...
        Msg msg = ZMQ.recv(second, ZMQUtilConstant.ZMQ_DONTWAIT);
        assertThat(msg, nullValue());

        // receiving from first connected pair
        msg = ZMQ.recv(first, ZMQUtilConstant.ZMQ_DONTWAIT);
        assertThat(msg, notNullValue());
        assertThat(msg.data(), is("data".getBytes(ZMQUtilConstant.CHARSET)));
        msg = ZMQ.recv(first, ZMQUtilConstant.ZMQ_DONTWAIT);
        assertThat(msg, notNullValue());
        assertThat(msg.data(), is("datb".getBytes(ZMQUtilConstant.CHARSET)));
        msg = ZMQ.recv(first, ZMQUtilConstant.ZMQ_DONTWAIT);
        assertThat(msg, notNullValue());
        assertThat(msg.data(), is("datc".getBytes(ZMQUtilConstant.CHARSET)));
    ...
    public void testPairMonitorBindConnect() throws IOException
    {
        ...
        SocketBase connect = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        ...
        rc = ZMQ.monitorSocket(connect, "inproc://events", ZMQUtilConstant.ZMQ_EVENT_ALL);
        assertThat(rc, is(true));
    ...
    public void testPairMonitorIssue291() throws IOException
    {
        ...
        SocketBase monitored = ZMQ.socket(ctx, ZMQUtilConstant.ZMQ_PAIR);
        assertThat(monitored, notNullValue());
        rc = ZMQ.monitorSocket(monitored, "inproc://events", ZMQUtilConstant.ZMQ_EVENT_ALL);
        assertThat(rc, is(true));
