...
public class TestReqrepDevice
{
    ...
    public void testReprepDevice() throws IOException
    {
        ...
        rc = ZMQ.send(req, "ABC", ZMQUtilConstant.ZMQ_SNDMORE);
        assertThat(rc, is(3));
        ...
        for (int i = 0; i != 4; i++) {
            ...
            rcvmore = ZMQ.getSocketOption(router, ZMQUtilConstant.ZMQ_RCVMORE);
            rc = ZMQ.sendMsg(dealer, msg, rcvmore > 0 ? ZMQUtilConstant.ZMQ_SNDMORE : 0);
        ...
        buff = new String(msg.data(), ZMQUtilConstant.CHARSET);
        assertThat(buff, is("ABC"));
        rcvmore = ZMQ.getSocketOption(rep, ZMQUtilConstant.ZMQ_RCVMORE);
        ...
        //  Send the reply.
        rc = ZMQ.send(rep, "GHIJKL", ZMQUtilConstant.ZMQ_SNDMORE);
        assertThat(rc, is(6));
        ...
        for (int i = 0; i != 4; i++) {
            ...
            assertThat(msg, notNullValue());
            rcvmore = ZMQ.getSocketOption(dealer, ZMQUtilConstant.ZMQ_RCVMORE);
            rc = ZMQ.sendMsg(router, msg, rcvmore > 0 ? ZMQUtilConstant.ZMQ_SNDMORE : 0);
            assertThat(rc >= 0, is(true));
        }
        ...
        rcvmore = ZMQ.getSocketOption(req, ZMQUtilConstant.ZMQ_RCVMORE);
        assertThat(rcvmore > 0, is(true));
        msg = ZMQ.recv(req, 0);
