...
class Mtrie
{
    ...
    public boolean rm(Pipe pipe, IMtrieHandler func, IXPub pub)
    {
        assert (pipe != null);
        assert (func != null);
    ...
    private boolean rmHelper(Pipe pipe, byte[] buff, int buffsize, int maxBuffSize, IMtrieHandler func, IXPub pub)
    {
    ...
    public void match(ByteBuffer data, int size, IMtrieHandler func, IXPub pub)
    {
        assert (data != null);
        assert (func != null);
        assert (pub != null);
    ...
    public static interface IMtrieHandler {
        void invoke(Pipe pipe, byte[] data, int size, IXPub arg);
    }
}
