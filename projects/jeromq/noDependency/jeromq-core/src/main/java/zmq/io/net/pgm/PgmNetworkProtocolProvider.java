...
public class PgmNetworkProtocolProvider implements NetworkProtocolProvider<InetSocketAddress>
{
    ...
    {
        assert (options.type == ZMQUtilConstant.ZMQ_PUB || options.type == ZMQUtilConstant.ZMQ_XPUB || options.type == ZMQUtilConstant.ZMQ_SUB
                        || options.type == ZMQUtilConstant.ZMQ_XSUB);
                ...
                if (options.type == ZMQUtilConstant.ZMQ_PUB || options.type == ZMQUtilConstant.ZMQ_XPUB) {
                    //  PGM sender.
