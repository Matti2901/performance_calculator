...
public class ZStar implements ZAgent
{
    ...
    private static final class Plateau implements IAttachedRunnable, Exit
    {
        ...
        @Override
        public void run(final Object[] train, final IZContext chef, final Socket mic)
        {
            final int mandat = 5;
            ...
            if (entourage != null) {
                entourage.breakaleg((ZContext) chef, star, mic, bags);
            }
            ...
            try {
                ...
                showMustGoOn((ZContext) chef, set, mic, star, bags);
                ...
                try {
                    ...
                    star.party((ZContext) chef);
                    if (entourage != null) {
                        entourage.party((ZContext) chef);
                    }
                    // Sober again ...
