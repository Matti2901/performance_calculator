...
public class ZMQ
{
     ...
     */
    public static final int SNDMORE = ZMQUtilConstant.ZMQ_SNDMORE;

    // Values for flags in Socket's send and recv functions.
    /**
     * Socket flag to indicate a nonblocking send or recv mode.
     */
    public static final int DONTWAIT = ZMQUtilConstant.ZMQ_DONTWAIT;
    public static final int NOBLOCK  = ZMQUtilConstant.ZMQ_DONTWAIT;
     ...
     */
    @Deprecated
    public static final int PAIR = ZMQUtilConstant.ZMQ_PAIR;

    /**
     * @deprecated use {@link SocketType#PUB} instead
     */
    @Deprecated
    public static final int PUB = ZMQUtilConstant.ZMQ_PUB;
    /**
     * @deprecated use {@link SocketType#SUB} instead
     */
    @Deprecated
    public static final int SUB = ZMQUtilConstant.ZMQ_SUB;

    /**
     * @deprecated use {@link SocketType#REQ} instead
     */
    @Deprecated
    public static final int REQ = ZMQUtilConstant.ZMQ_REQ;

    /**
     * @deprecated use {@link SocketType#REP} instead
     */
    @Deprecated
    public static final int REP = ZMQUtilConstant.ZMQ_REP;

    /**
     * @deprecated use {@link SocketType#DISH} instead
     */
    @Deprecated
    public static final int DISH = ZMQUtilConstant.ZMQ_DISH;

    /**
     * @deprecated use {@link SocketType#RADIO} instead
     */
    @Deprecated
    public static final int RADIO = ZMQUtilConstant.ZMQ_RADIO;

    /**
     * @deprecated use {@link SocketType#DEALER} instead
     */
    @Deprecated
    public static final int DEALER = ZMQUtilConstant.ZMQ_DEALER;
    /**
    ...
    @Deprecated
    public static final int ROUTER = ZMQUtilConstant.ZMQ_ROUTER;
    /**
    ...
    @Deprecated
    public static final int PULL = ZMQUtilConstant.ZMQ_PULL;

    @Deprecated
    public static final int PUSH = ZMQUtilConstant.ZMQ_PUSH;

    @Deprecated
    public static final int XPUB = ZMQUtilConstant.ZMQ_XPUB;

    @Deprecated
    public static final int XSUB = ZMQUtilConstant.ZMQ_XSUB;

    @Deprecated
    public static final int STREAM     = ZMQUtilConstant.ZMQ_STREAM;
    /**
     * Flag to specify a STREAMER device.
     */
    @Deprecated
    public static final int STREAMER   = ZMQUtilConstant.ZMQ_STREAMER;
    /**
     * Flag to specify a FORWARDER device.
     */
    @Deprecated
    public static final int FORWARDER  = ZMQUtilConstant.ZMQ_FORWARDER;
    /**
     * Flag to specify a QUEUE device.
     */
    @Deprecated
    public static final int QUEUE      = ZMQUtilConstant.ZMQ_QUEUE;
    /**
     ...
     */
    public static final int EVENT_CONNECTED          = ZMQUtilConstant.ZMQ_EVENT_CONNECTED;
    /**
     ...
     * no meaning.
     */
    public static final int EVENT_CONNECT_DELAYED    = ZMQUtilConstant.ZMQ_EVENT_CONNECT_DELAYED;
    /**
     ...
     */
    public static final int EVENT_CONNECT_RETRIED    = ZMQUtilConstant.ZMQ_EVENT_CONNECT_RETRIED;
    /**
     ...
     */
    public static final int EVENT_LISTENING          = ZMQUtilConstant.ZMQ_EVENT_LISTENING;
    /**
     ...
     */
    public static final int EVENT_BIND_FAILED        = ZMQUtilConstant.ZMQ_EVENT_BIND_FAILED;
    /**
     ...
     * the accepted socket.
     */
    public static final int EVENT_ACCEPTED           = ZMQUtilConstant.ZMQ_EVENT_ACCEPTED;
    /**
     ...
     */
    public static final int EVENT_ACCEPT_FAILED      = ZMQUtilConstant.ZMQ_EVENT_ACCEPT_FAILED;
    /**
     ...
     */
    public static final int EVENT_CLOSED             = ZMQUtilConstant.ZMQ_EVENT_CLOSED;
    /**
     ...
     */
    public static final int EVENT_CLOSE_FAILED       = ZMQUtilConstant.ZMQ_EVENT_CLOSE_FAILED;
    /**
     ...
     * the socket.
     */
    public static final int EVENT_DISCONNECTED       = ZMQUtilConstant.ZMQ_EVENT_DISCONNECTED;
    /**
     * EVENT_MONITOR_STOPPED: monitor has been stopped.
     * The EVENT_MONITOR_STOPPED event triggers when the monitor for a socket is
     * stopped.
     */
    public static final int EVENT_MONITOR_STOPPED    = ZMQUtilConstant.ZMQ_EVENT_MONITOR_STOPPED;
    /**
     ...
     */
    public static final int EVENT_HANDSHAKE_PROTOCOL = ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_PROTOCOL;
    /**
     * EVENT_ALL: all events known.
     * The EVENT_ALL constant can be used to set up a monitor for all known events.
     */
    public static final int EVENT_ALL                = ZMQUtilConstant.ZMQ_EVENT_ALL;

    /**
     * Unspecified system errors during handshake. Event value is an errno.
     */
    public static final int HANDSHAKE_FAILED_NO_DETAIL   = ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL;

    /**
     * Handshake complete successfully with successful authentication (if
     *  enabled). Event value is unused.
     */
    public static final int HANDSHAKE_SUCCEEDED      = ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_SUCCEEDED;

    /**
     *   Protocol errors between ZMTP peers or between server and ZAP handler.
     *  Event value is one of ZMQ_PROTOCOL_ERROR_*
     */
    public static final int HANDSHAKE_FAILED_PROTOCOL = ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL;
    /**
     *   Failed authentication requests. Event value is the numeric ZAP status
     *  code, i.e. 300, 400 or 500.
     */
    public static final int HANDSHAKE_FAILED_AUTH     = ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_FAILED_AUTH;

    public static final byte[] MESSAGE_SEPARATOR = ZMQUtilConstant.MESSAGE_SEPARATOR;

    public static final byte[] SUBSCRIPTION_ALL = ZMQUtilConstant.SUBSCRIPTION_ALL;

    public static final byte[] PROXY_PAUSE     = ZMQUtilConstant.PROXY_PAUSE;
    public static final byte[] PROXY_RESUME    = ZMQUtilConstant.PROXY_RESUME;
    public static final byte[] PROXY_TERMINATE = ZMQUtilConstant.PROXY_TERMINATE;

    public static final Charset CHARSET = ZMQUtilConstant.CHARSET;
    ...
    public static int poll(Selector selector, PollItem[] items, int count, long timeout)
    {
        ...
        return ZMQPoll.poll(selector, pollItems, count, timeout);
    }
    ...
    {
        return ZMQUtilConstant.ZMQ_VERSION_MAJOR;
    }
    ...
    {
        return ZMQUtilConstant.ZMQ_VERSION_MINOR;
    }
    ...
    {
        return ZMQUtilConstant.ZMQ_VERSION_PATCH;
    }
    ...
    {
        return zmq.ZMQ.makeVersion(ZMQUtilConstant.ZMQ_VERSION_MAJOR, ZMQUtilConstant.ZMQ_VERSION_MINOR, ZMQUtilConstant.ZMQ_VERSION_PATCH);
    }
    ...
    {
        return "" + ZMQUtilConstant.ZMQ_VERSION_MAJOR + "." + ZMQUtilConstant.ZMQ_VERSION_MINOR + "." + ZMQUtilConstant.ZMQ_VERSION_PATCH;
    }
    ...
    public static class Context implements Closeable
    {
        ...
        {
            return ctx.get(ZMQUtilConstant.ZMQ_IO_THREADS);
        }
        ...
        {
            return ctx.set(ZMQUtilConstant.ZMQ_IO_THREADS, ioThreads);
        }
        ...
        {
            return ctx.get(ZMQUtilConstant.ZMQ_MAX_SOCKETS);
        }
        ...
        {
            return ctx.set(ZMQUtilConstant.ZMQ_MAX_SOCKETS, maxSockets);
        }
        ...
        {
            return ctx.get(ZMQUtilConstant.ZMQ_BLOCKY) != 0;
        }

        public boolean setBlocky(boolean block)
        {
            return ctx.set(ZMQUtilConstant.ZMQ_BLOCKY, block ? 1 : 0);
        }

        public boolean isIPv6()
        {
            return ctx.get(ZMQUtilConstant.ZMQ_IPV6) != 0;
        }
        ...
        {
            return ctx.set(ZMQUtilConstant.ZMQ_IPV6, ipv6 ? 1 : 0);
        }
     ...
     * </ul>
     */
    public static class Socket implements Closeable,ISocket
    {
        ...
        public int getType()
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TYPE);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_LINGER);
        }
        ...
        {
            return base.setSocketOpt(ZMQUtilConstant.ZMQ_LINGER, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RECONNECT_IVL);
        }
        ...
        {
            return base.setSocketOpt(ZMQUtilConstant.ZMQ_RECONNECT_IVL, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_BACKLOG);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_BACKLOG, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_HANDSHAKE_IVL);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_IVL);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_TIMEOUT);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_TTL);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(ZMQUtilConstant.ZMQ_HEARTBEAT_CONTEXT);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HANDSHAKE_IVL, maxHandshakeIvl);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_IVL, heartbeatIvl);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_TIMEOUT, heartbeatTimeout);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_TTL, heartbeatTtl);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HEARTBEAT_CONTEXT, pingContext);
        }
        ...
        public int getTos()
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TOS);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_TOS, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RECONNECT_IVL_MAX);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_RECONNECT_IVL_MAX, value);
        }
        ...
        {
            return (Long) base.getSocketOptx(ZMQUtilConstant.ZMQ_MAXMSGSIZE);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_MAXMSGSIZE, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_SNDHWM);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SNDHWM, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RCVHWM);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_RCVHWM, value);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CONFLATE, conflate);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_CONFLATE) != 0;
        }
        ...
        {
            return (Long) base.getSocketOptx(ZMQUtilConstant.ZMQ_AFFINITY);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_AFFINITY, value);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(ZMQUtilConstant.ZMQ_IDENTITY);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_IDENTITY, identity);
        }
        ...
        public long getRate()
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RATE);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RECOVERY_IVL);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_REQ_CORRELATE, correlate);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_REQ_RELAXED, relaxed);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_MULTICAST_HOPS);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RCVTIMEO);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_RCVTIMEO, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_SNDTIMEO);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SNDTIMEO, value);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_CNT, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_CNT);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_INTVL, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_INTVL);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_IDLE, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE_IDLE);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_SNDBUF);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SNDBUF, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RCVBUF);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_RCVBUF, value);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_RCVMORE) == 1;
        }
        ...
        {
            return (SelectableChannel) base.getSocketOptx(ZMQUtilConstant.ZMQ_FD);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_EVENTS);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_UNSUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_ENCODER, cls);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_DECODER, cls);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD, threshold);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_MSG_ALLOCATOR, allocator);
        }
        ...
        {
            return base.setSocketOpt(ZMQUtilConstant.ZMQ_SELECTOR_PROVIDERCHOOSER, chooser);
        }
        ...
        {
            return (SelectorProviderChooser) base.getSocketOptx(ZMQUtilConstant.ZMQ_SELECTOR_PROVIDERCHOOSER);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CONNECT_RID, rid);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_ROUTER_RAW, raw);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_PROBE_ROUTER, probe);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_ROUTER_MANDATORY, mandatory);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_ROUTER_HANDOVER, handover);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_XPUB_VERBOSE, verbose);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_XPUB_NODROP, noDrop);
        }

        public boolean setXpubManual(boolean manual)
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_XPUB_MANUAL, manual);
        }

        public boolean setXpubVerboser(boolean verboser)
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_XPUB_VERBOSER, verboser);
        }
        ...
        public boolean isIPv6()
        {
            return (Boolean) base.getSocketOptx(ZMQUtilConstant.ZMQ_IPV6);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_IPV6, v6);
        }
        ...
        {
            return base.getSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_TCP_KEEPALIVE, optVal);
        }
        ...
        {
            return (boolean) base.getSocketOptx(ZMQUtilConstant.ZMQ_IMMEDIATE);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_IMMEDIATE, value);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SOCKS_PROXY, proxy);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_SOCKS_PROXY);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_LAST_ENDPOINT);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_ZAP_DOMAIN, domain);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_ZAP_DOMAIN);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_SELFADDR_PROPERTY_NAME);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_SELFADDR_PROPERTY_NAME, recordName);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_SERVER, server);
        }
        ...
        {
            return (Boolean) base.getSocketOptx(ZMQUtilConstant.ZMQ_PLAIN_SERVER);
        }
        ...
        {
            return base.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_USERNAME, username);
        }
        ...
        {
            return base.setSocketOpt(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD, password);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_PLAIN_USERNAME);
        }
        ...
        {
            return (String) base.getSocketOptx(ZMQUtilConstant.ZMQ_PLAIN_PASSWORD);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CURVE_SERVER, server);
        }
        ...
        {
            return (boolean) base.getSocketOptx(ZMQUtilConstant.ZMQ_CURVE_SERVER);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CURVE_PUBLICKEY, key);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CURVE_SERVERKEY, key);
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_CURVE_SECRETKEY, key);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(ZMQUtilConstant.ZMQ_CURVE_PUBLICKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(ZMQUtilConstant.ZMQ_CURVE_SERVERKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(ZMQUtilConstant.ZMQ_CURVE_SECRETKEY);
        }
        ...
        {
            return Mechanism.find((Mechanisms) base.getSocketOptx(ZMQUtilConstant.ZMQ_MECHANISM));
        }
        ...
        {
            return setSocketOpt(ZMQUtilConstant.ZMQ_HELLO_MSG, helloMsg);
        }
        ...
        {
            return sendMsg(msg, ZMQUtilConstant.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data.getBytes(CHARSET), ZMQUtilConstant.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data, ZMQUtilConstant.ZMQ_SNDMORE);
        }
    ...
    public static class Poller implements Closeable
    {
         ...
         */
        public static final int POLLIN  = ZMQUtilConstant.ZMQ_POLLIN;
        /**
         ...
         */
        public static final int POLLOUT = ZMQUtilConstant.ZMQ_POLLOUT;
        /**
         * For standard sockets, this flag is passed through {@link ZMQPoll#poll(Selector, zmq.poll.PollItem[], long)} to the underlying poll() system call
         * and generally means that some sort of error condition is present on the socket specified by fd.
         * <br>
         * For ØMQ sockets this flag has no effect if set in events, and shall never be returned in revents by {@link ZMQPoll#poll(Selector, zmq.poll.PollItem[], long)}.
         */
        public static final int POLLERR = ZMQUtilConstant.ZMQ_POLLERR;
        ...
        public int poll(long tout)
        {
            ...
            try {
                return ZMQPoll.poll(selector, pollItems, items.size(), tout);
            }
    ...
    public static class Event
    {
        ...
        public static Event recv(Socket socket, int flags)
        {
            ...
            switch (e.event) {
            case ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL:
                resolvedValue = ProtocolCode.findByCode((Integer) e.arg);
                break;
            case ZMQUtilConstant.ZMQ_EVENT_CLOSE_FAILED:
            case ZMQUtilConstant.ZMQ_EVENT_ACCEPT_FAILED:
            case ZMQUtilConstant.ZMQ_EVENT_BIND_FAILED:
            case ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL:
                resolvedValue = ZError.Error.findByCode((Integer) e.arg);
                break;
            case ZMQUtilConstant.ZMQ_EVENT_CONNECTED:
            case ZMQUtilConstant.ZMQ_EVENT_LISTENING:
            case ZMQUtilConstant.ZMQ_EVENT_ACCEPTED:
            case ZMQUtilConstant.ZMQ_EVENT_CLOSED:
            case ZMQUtilConstant.ZMQ_EVENT_DISCONNECTED:
                resolvedValue = e.getChannel(socket.base);
                break;
            case ZMQUtilConstant.ZMQ_EVENT_CONNECT_DELAYED:
            case ZMQUtilConstant.ZMQ_EVENT_HANDSHAKE_SUCCEEDED:
            case ZMQUtilConstant.ZMQ_EVENT_MONITOR_STOPPED:
                resolvedValue = null;
                break;
            default:
                resolvedValue = e.arg;
         ...
         * <li> {@link ZError.Error} for any other error.</li>
