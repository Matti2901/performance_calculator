...
import org.openmrs.api.db.dao.metadata.OpenmrsMetadataDAO;
...
public class HibernateOpenmrsMetadataDAO<T extends BaseOpenmrsMetadata> extends HibernateOpenmrsObjectDAO<T> implements OpenmrsMetadataDAO<T> {
	...
	/**
	 * @see OpenmrsMetadataDAO#getAll(boolean)
	 */
	@Override
	...
	/**
	 * @see OpenmrsMetadataDAO#getAll(boolean, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see OpenmrsMetadataDAO#getAllCount(boolean)
	 */
	@Override
