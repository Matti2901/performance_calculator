...
import org.openmrs.customdatatype.sumary.Summary;
...
public class DateDatatype extends SerializingCustomDatatype<Date> {
	 ...
	 */
	@Override
	public Summary doGetTextSummary(Date typedValue) {
		return new Summary(Context.getDateFormat().format(typedValue), true);
	}
