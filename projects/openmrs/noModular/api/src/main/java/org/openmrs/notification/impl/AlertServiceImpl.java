...
import org.openmrs.notification.alert.AlertRecipient;
...
public class AlertServiceImpl extends BaseOpenmrsService implements Serializable, AlertService {
	...
	/**
	 * @see AlertService#setAlertDAO(org.openmrs.notification.db.AlertDAO)
	 */
	@Override
	...
	/**
	 * @see AlertService#getAlert(java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see AlertService#getAllActiveAlerts(org.openmrs.User)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see AlertService#getAlertsByUser(org.openmrs.User)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see AlertService#notifySuperUsers(String, Exception, Object...)
	 */
	@Override
