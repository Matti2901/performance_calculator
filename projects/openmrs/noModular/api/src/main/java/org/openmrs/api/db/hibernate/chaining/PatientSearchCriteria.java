...
import org.openmrs.api.db.hibernate.person.search.PersonSearchCriteria;
...
public class PatientSearchCriteria {
	 ...
	 * than org.openmrs.api.db.hibernate.person.HibernatePatientDAO.
	 *
	 * Instead of calling this method consider using {@link org.openmrs.api.PatientService} or
	 * {@link PatientDAO}.
	 *
	 ...
	 */
	public Criteria prepareCriteria(String query, boolean includeVoided) {
	 ...
	 * @return criteria for searching by name OR identifier OR searchable attributes
	 */
	public Criteria prepareCriteria(String query) {
	 ...
	 * @return criteria for searching by name OR identifier OR searchable attributes
	 */
	public Criteria prepareCriteria(String query, Boolean matchExactly, boolean orderByNames, boolean includeVoided) {
		addAliasForName(criteria, orderByNames);
	 ...
	 */
	public String copySearchParameter(String source, String target) {
	 ...
	 */
	public PatientSearchMode getSearchMode(String name, String identifier, List<PatientIdentifierType> identifierTypes,
	 ...
	 **/
	public String[] getQueryParts(String query) {
		if (query == null) {
