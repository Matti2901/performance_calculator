 ...
 */
package org.openmrs.api.db.hibernate.metadata;
...
import org.openmrs.api.db.dao.metadata.OpenmrsObjectDAO;
...
public class HibernateOpenmrsObjectDAO<T extends BaseOpenmrsObject> implements OpenmrsObjectDAO<T> {
	...
	/**
	 * @see OpenmrsObjectDAO#getByUuid(java.lang.String)
	 */
	@Override
	...
	/** 
	 * @see OpenmrsObjectDAO#delete(org.openmrs.BaseOpenmrsObject)
	 */
	@Override
	...
	/**
	 * @see OpenmrsObjectDAO#saveOrUpdate(org.openmrs.BaseOpenmrsObject)
	 */
	@Override
