...
import org.openmrs.api.db.dao.metadata.OpenmrsDataDAO;
...
public class HibernateOpenmrsDataDAO<T extends BaseOpenmrsData> extends HibernateOpenmrsObjectDAO<T> implements OpenmrsDataDAO<T> {
	...
	/**
	 * @see OpenmrsDataDAO#getAll(boolean)
	 */
	@Override
	...
	/**
	 * @see OpenmrsDataDAO#getAll(boolean, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see OpenmrsDataDAO#getAllCount(boolean)
	 */
	@Override
