 ...
 */
package org.openmrs.api.db.hibernate.clinical.obs;
...
import org.openmrs.api.db.dao.encounter.ObsDAO;
...
public class HibernateObsDAO implements ObsDAO {
	...
	/**
	 * @see ObsDAO#saveObs(org.openmrs.Obs)
	 */
	@Override
	...
	/**
	 * @see ObsDAO#getObservations(List, List, List, List, List, List, List,
	...
	/**
	 * @see ObsDAO#getObservationCount(List, List, List, List, List, List, Integer, Date, Date, List, boolean, String)
	 */
	@Override
	...
	/**
	 * @see ObsDAO#getObsByUuid(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see ObsDAO#getRevisionObs(org.openmrs.Obs)
	 */
	@Override
	...
	/**
	 * @see ObsDAO#getSavedStatus(org.openmrs.Obs)
	 */
	@Override
