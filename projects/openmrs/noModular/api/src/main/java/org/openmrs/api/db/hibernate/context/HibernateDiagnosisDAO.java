...
import org.openmrs.api.db.dao.condition.DiagnosisDAO;
...
public class HibernateDiagnosisDAO implements DiagnosisDAO {
	...
	/**
	 * @see DiagnosisDAO#getDiagnosesByEncounter(Encounter, boolean, boolean)
	 */
	@Override
	...
	/**
	 * @see DiagnosisDAO#getDiagnosesByVisit(Visit, boolean, boolean)
	 */
	@Override
	...
	/**
	 * @see DiagnosisDAO#getAllDiagnosisAttributeTypes()
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * @see DiagnosisDAO#getDiagnosisAttributeTypeById(Integer) 
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see DiagnosisDAO#getDiagnosisAttributeTypeByUuid(String)
	 */
	@Override
	@Transactional(readOnly = true)
	...
	/**
	 * @see DiagnosisDAO#saveDiagnosisAttributeType(DiagnosisAttributeType)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see DiagnosisDAO#deleteDiagnosisAttributeType(DiagnosisAttributeType)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see DiagnosisDAO#getDiagnosisAttributeByUuid(String)
	 */
	@Override
	@Transactional(readOnly = true)
