 ...
 */
package org.openmrs.scheduler.tasks.thread;
...
public class TaskThreadedInitializationWrapper implements Task {
	...
	/**
	 * @see Task#execute() Executes the task defined in the task definition
	...
	/**
	 * @see Task#initialize(TaskDefinition) Initializes
