...
import org.openmrs.util.manager.ExistingVisitAssignmentHandler;
...
public class ExistingOrNewVisitAssignmentHandler extends ExistingVisitAssignmentHandler implements GlobalPropertyListener {
	...
	/**
	 * @see ExistingVisitAssignmentHandler#getDisplayName(java.util.Locale)
	 */
	@Override
	...
	/**
	 * @see ExistingVisitAssignmentHandler#beforeCreateEncounter(org.openmrs.Encounter)
