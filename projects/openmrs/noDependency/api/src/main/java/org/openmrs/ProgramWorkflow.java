...
public class ProgramWorkflow extends BaseChangeableOpenmrsMetadata {
	 ...
	 */
	public List<ProgramWorkflowState> getPossibleNextStates(PatientStateInterface patientProgram) {
		List<ProgramWorkflowState> ret = new ArrayList<>();
		PatientState currentState = new PatientState(patientProgram.getCurrentState(this.getId()));
