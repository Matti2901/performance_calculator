...
import org.openmrs.stable.exception.ObsException;
...
public class Obs extends BaseFormRecordableOpenmrsData {
	...
	public void addGroupMember(Obs member) {
		...
		if (member.equals(this)) {
			throw new ObsException("Obs.error.groupCannotHaveItselfAsAMentor", new Object[] { this, member });
		}
	...
	protected void markAsDirty(Object oldValue, Object newValue) {
		...
		if (!isDirty() && obsId != null && !Comparator.nullSafeEquals(oldValue, newValue)) {
			dirty = true;
		}
	}
