 ...
 */
@Deprecated
public class MemoryAppender extends org.openmrs.util.manager.MemoryAppender {
	
	private final org.openmrs.util.manager.MemoryAppender implementation;
	
	MemoryAppender(org.openmrs.util.manager.MemoryAppender implementation) {
