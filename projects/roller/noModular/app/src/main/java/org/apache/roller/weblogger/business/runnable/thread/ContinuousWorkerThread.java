...
public class ContinuousWorkerThread extends WorkerThread {
    ...
    public void run() {
        ...
        mLogger.info(this.getId() +" Started.");
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                mLogger.debug(this.getId() + " SLEEPING for " + this.sleepTime + " milliseconds ...");
                Thread.sleep(this.sleepTime);
            } catch (InterruptedException e) {
                mLogger.info(this.getId() + " INTERRUPT: " + e.getMessage());
                break;
            }
        }

        mLogger.info(this.getId() +" Done.");
    }
