...
package org.apache.roller.weblogger.ui.struts2.editor.entry.bean;
...
public class Entries extends UIAction {
    ...
    public String execute() {
        ...
        try {
            ...
            wesc.setStatus("ALL".equals(status) ? null : PubStatus.valueOf(status));
    ...
    public List<KeyValueObject> getSortByOptions() {
        ...
        opts.add(new KeyValueObject(SortBy.PUBLICATION_TIME.name(), getText("weblogEntryQuery.label.pubTime")));
        opts.add(new KeyValueObject(SortBy.UPDATE_TIME.name(), getText("weblogEntryQuery.label.updateTime")));
