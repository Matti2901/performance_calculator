...
package org.apache.roller.weblogger.ui.struts2.editor.entry.edit;
...
import org.apache.roller.util.date.DateUtil;
...
import org.apache.roller.weblogger.pojos.core.*;
import org.apache.roller.weblogger.pojos.core.permission.GlobalPermission;
import org.apache.roller.weblogger.pojos.core.sort.SortBy;
...
import org.apache.roller.weblogger.pojos.core.weblog.WeblogEntrySearchCriteria;
...
import org.apache.roller.weblogger.ui.struts2.util.ui.UIAction;
import org.apache.roller.weblogger.util.cache.CacheManager;
import org.apache.roller.weblogger.util.i18manage.MailUtil;
import org.apache.roller.weblogger.util.mediacast.MediacastException;
import org.apache.roller.weblogger.util.mediacast.MediacastResource;
import org.apache.roller.weblogger.util.mediacast.MediacastUtil;
import org.apache.roller.weblogger.util.i18manage.RollerMessages;
import org.apache.roller.weblogger.util.i18manage.RollerMessage;
import org.apache.roller.weblogger.util.i18manage.Trackback;
import org.apache.roller.weblogger.util.i18manage.TrackbackNotAllowedException;
...
public final class EntryEdit extends UIAction {
    ...
    public List<WeblogEntry> getRecentPublishedEntries() {
        return getRecentEntries(PubStatus.PUBLISHED, SortBy.PUBLICATION_TIME);
    }
    ...
    public List<WeblogEntry> getRecentScheduledEntries() {
        return getRecentEntries(PubStatus.SCHEDULED, SortBy.PUBLICATION_TIME);
    }
    ...
    public List<WeblogEntry> getRecentDraftEntries() {
        return getRecentEntries(PubStatus.DRAFT, SortBy.UPDATE_TIME);
    }
    ...
    public List<WeblogEntry> getRecentPendingEntries() {
        return getRecentEntries(PubStatus.PENDING, SortBy.UPDATE_TIME);
    }

    private List<WeblogEntry> getRecentEntries(PubStatus pubStatus, SortBy sortBy) {
