...
package org.apache.roller.weblogger.business.file;
...
public class FileContentManagerImpl implements FileContentManager {
    ...
    /**
     * @see FileContentManager#getFileContent(Weblog,
     *      String)
     */
    @Override
    ...
    /**
     * @see FileContentManager#saveFileContent(Weblog,
    ...
    /**
     * @see FileContentManager#deleteFile(Weblog,
     *      String)
     */
    @Override
    ...
    /**
     * @see FileContentManager#overQuota(Weblog)
     */
    @Override
    ...
    /**
     * @see FileContentManager#canSave(Weblog,
