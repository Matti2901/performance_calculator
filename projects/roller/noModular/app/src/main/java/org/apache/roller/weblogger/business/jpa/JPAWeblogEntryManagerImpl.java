...
import org.apache.roller.weblogger.pojos.core.approval.CommentSearchCriteria;
import org.apache.roller.weblogger.pojos.core.sort.SortBy;
import org.apache.roller.weblogger.pojos.core.sort.SortOrder;
import org.apache.roller.weblogger.pojos.core.weblog.*;
import org.apache.roller.weblogger.pojos.stat.StatCount;
import org.apache.roller.weblogger.pojos.tag.TagStat;
import org.apache.roller.weblogger.pojos.tag.TagStatComparator;
import org.apache.roller.weblogger.pojos.tag.TagStatCountComparator;
...
public class JPAWeblogEntryManagerImpl implements WeblogEntryManager {
    ...
    public List<WeblogEntry> getWeblogEntries(WeblogEntrySearchCriteria wesc) throws WebloggerException {
        ...
        if (wesc.getSortBy() != null && wesc.getSortBy().equals(SortBy.UPDATE_TIME)) {
            queryString.append(" ORDER BY e.updateTime ");
        } else {
            queryString.append(" ORDER BY e.pubTime ");
        }
        
        if (wesc.getSortOrder() != null && wesc.getSortOrder().equals(SortOrder.ASCENDING)) {
