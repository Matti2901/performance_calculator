...
import org.apache.roller.weblogger.business.file.FileContentManager;
import org.apache.roller.weblogger.business.hit.HitCountQueue;
import org.apache.roller.weblogger.business.init.InitializationException;
import org.apache.roller.weblogger.business.init.MediaFileManager;
import org.apache.roller.weblogger.business.init.PropertiesManager;
import org.apache.roller.weblogger.business.pings.manager.AutoPingManager;
import org.apache.roller.weblogger.business.pings.queue.PingQueueManager;
...
public abstract class WebloggerImpl implements Weblogger {
     ...
     * 
     * 
     * @see Weblogger#getThreadManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getBookmarkManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getMediaFileManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getFileContentManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getWeblogEntryManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getWeblogManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getPropertiesManager()
     */
    @Override
     ...
     * 
     * 
     * @see Weblogger#getPingTargetManager()
     */
    @Override
     ...
     *
     *
     * @see Weblogger#getPluginManager()
     */
    @Override
