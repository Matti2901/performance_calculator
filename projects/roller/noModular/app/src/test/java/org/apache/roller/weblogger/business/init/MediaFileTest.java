 ...
 */
package org.apache.roller.weblogger.business.init;
...
import org.apache.roller.weblogger.pojos.core.filter.MediaFileOrder;
import org.apache.roller.weblogger.pojos.core.filter.SizeFilterType;
...
public class MediaFileTest  {
    ...
    public void testSearchMediaFile() throws Exception {
        ...
        try {
            ...
            filter6.setSizeFilterType(SizeFilterType.LT);
            ...
            filter7.setSizeFilterType(SizeFilterType.EQ);
            ...
            filter8.setSizeFilterType(SizeFilterType.GT);
            ...
            filter9.setSizeFilterType(SizeFilterType.LTE);
            ...
            filter10.setSizeFilterType(SizeFilterType.GTE);
