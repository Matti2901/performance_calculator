...
public class GlobalPermission extends RollerPermission {
    ...
    /**
     * Create global permission for one specific UserInterface initialized with the 
     * actions that are implied by the UserInterface's roles.
     * @throws org.apache.roller.weblogger.WebloggerException
     */
    public GlobalPermission(UserInterface userInterface) throws WebloggerException {

        super("GlobalPermission UserInterface: " + userInterface.getUserName());
        
        // loop through UserInterface's roles, adding actions implied by each
        List<String> roles = WebloggerFactory.getWeblogger().getUserManager().getRoles(userInterface.getUserName());
    ...
    public GlobalPermission(List<String> actions) throws WebloggerException {
        super("GlobalPermission UserInterface: N/A");
     ...
     * @param userInterface UserInterface of permission.
     * @throws org.apache.roller.weblogger.WebloggerException
     */
    public GlobalPermission(UserInterface userInterface, List<String> actions) throws WebloggerException {
        super("GlobalPermission UserInterface: " + userInterface.getUserName());
        setActionsAsList(actions);
    }
